...
// fired on a varying 2-4 day cadence to VERIFIED vendors whose public listing is
// missing photo / bio / pricing / packages / availability, capped at 5 sends,
// with rotating copy so no two reminders read the same.
//
