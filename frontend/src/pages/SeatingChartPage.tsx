      ...
      <section className="relative">
        <div className="mx-auto max-w-2xl px-4 py-14 sm:px-6 sm:py-20">
          ...
          <div className="mt-8 space-y-3">
            {[
              { q: t("tools.seating_chart.faq_q1"), a: t("tools.seating_chart.faq_a1") },
              { q: t("tools.seating_chart.faq_q2"), a: t("tools.seating_chart.faq_a2") },
              { q: t("tools.seating_chart.faq_q3"), a: t("tools.seating_chart.faq_a3") },
            ].map((entry) => (
              <details
                key={entry.q}
