...
const ROOTS_HU: readonly string[] = [
  ...
  "Mit csinált az apád, amikor anyád sírt? És fordítva?",
  ...
  "Volt a családodban olyan rokon, akinek a házassága titokban szétesett, miközben kifelé tartotta magát?",
  "Mit hallottál otthon a párom neméről általában?",
  "Milyen volt nálatok a csend a vacsoraasztalnál?",
  "Hogyan ünnepelték nálatok a sikert, és hogyan kezelték a kudarcot?",
  "Milyen családi titokról tudsz, és nem szabadna?",
  "Volt-e olyan rokon, akinek a halála megváltoztatta a családodat?",
  "Milyen szülő volt a tied, és milyen szülő akarsz lenni?",
  "Hogyan szólítod a szüleimet, és miért pont úgy?",
  ...
  "Hogyan szeretnél emlékezni az anyádra, ha egyszer már nem lesz?",
  "Mit jelent neked a vasárnapi ebéd?",
  "Mit kérnél a szüleinktől, amit eddig nem mertél?",
  "Ha húsz év múlva megkérdezné a gyerekünk, miért választottátok egymást, ennyire különbözőket, mit válaszolnál?",
];
...
const EVERYDAY_HU: readonly string[] = [
  "Mennyi az a havi összeg, amit kérdés nélkül elkölthetek?",
  "Tudod, mennyit keresek nettóban? És én tudom-e nálad?",
  ...
  "Mit szólnál, ha többet keresnék nálad? És fordítva?",
  ...
  "Mennyi időt töltünk a saját szüleinkkel? Mennyi a sok?",
  "Mit szabad az anyósomnak, és mit nem?",
  "Hány gyereket akarsz, és mi van, ha nem jön?",
  ...
  "Ki vásárol, ki főz, ki visz orvoshoz egy beteg szülőt?",
  "Mennyi rendetlenség az, amitől fizikailag rosszul leszel?",
  "Hány estét tölthetek egyedül a barátaimmal egy hónapban?",
  "Mit posztolhatok rólunk anélkül, hogy megkérdezzelek?",
  "Van olyan exem, akit követek, és zavar téged?",
  "Melyik barátom nem tetszik neked, és miért nem mondtad eddig?",
...
const CLOSENESS_HU: readonly string[] = [
  "Mikor érezted magad utoljára kívánatosnak az én szememben?",
  "Mit jelent neked a hűség pontosan? Húzz egy vonalat.",
  "Mit jelent neked az érintés szex nélkül?",
  "Mikor érintettelek meg utoljára úgy, hogy nem akartam semmit?",
  "Mit szeretsz magadon, amit én még nem vettem észre?",
  "Hogyan mondod meg, ha valami nem esik jól az ágyban?",
  "Mit szeretnél, hogy ma este először érintsek meg?",
  "Mi az, amit szexuálisan kipróbálnál, de szégyelled megkérdezni?",
  "Melyik csókunk forog még a fejedben?",
  "Mit szoktál nézni rajtam, amikor azt hiszed, nem veszem észre?",
  "Mit suttognál nekem holnap reggel, ha tudnád, hogy senki más nem hallja?",
  "Mit csinálsz, ha hetekig nem szeretkezünk: eltűnsz, kérdezel, vagy duzzogsz?",
  "Mit jelent neked a flörtölés másokkal?",
  "Volt olyan, hogy igent mondtál szexre, miközben nemet akartál mondani?",
  "Hol érzed magad a legmeztelenebbnek anélkül, hogy vetkőznél?",
  "Ha terhesség, betegség vagy idő miatt nem tudnánk szeretkezni egy évig, mi tartana minket össze?",
  "Milyen érintést kérnél tőlem most, ha nem kellene szégyellned?",
  "Melyik közös pillanatunkon nevetsz még most is egyedül?",
  "Mi a legcikibb dolog, amit kettőnkről tudsz?",
  "Mit kérdeznél tőlem, ha biztos lennél benne, hogy nem nevetlek ki?",
  "Hova szöknénk el egy hosszú hétvégére bejelentés nélkül?",
  "Mit jelent neked a meztelenség azon kívül, hogy ruha nélkül vagy?",
  "Hogyan kívánsz öregedni mellettem, ha választhatsz?",
  "Ha holnap nem lenne szex közöttünk soha többé, maradnál?",
  "Mi a leggyengédebb dolog, amit valaki valaha tett veled?",
];
...
const DEEPWATER_HU: readonly string[] = [
  ...
  "Mit tegyek, ha depressziós leszel? Konkrétan, az első héten.",
  "Mit szeretnél, hogy mondjak rólad a temetéseden?",
  ...
  "Hogyan gyászolsz? Honnan tudjam, mit kérsz tőlem, amikor gyászolsz?",
  "Mit teszel, ha az egyikünk megcsalja a másikat? Megbocsátható, és milyen feltételekkel?",
  "Mit szólnál ahhoz, hogy terápiába menjünk, ha megakadunk?",
  "Mi az a határ, amin túl elhagynál engem?",
  "Mire emlékezzenek rólunk, ha minket már elfelejtettek?",
  "Mit jelent neked az értelmes élet a teljesítményen túl?",
  "Mit hagynál a gyerekünkre, ami nem mérhető forintban?",
  "Mit tennél az első évben, ha én megyek el előbb?",
  "Hol szeretnéd, hogy eltemessünk?",
  "Mit teszel, ha a hited megváltozik a házasság alatt, és az enyém nem?",
  "Hogyan döntsünk, ha egy szülőnket otthonba kell helyezni?",
  ...
  "Mikor érzed magad a legkevésbé egyedül, miközben velem vagy?",
