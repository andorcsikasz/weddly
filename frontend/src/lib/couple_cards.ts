...
const CLOSENESS_HU: readonly string[] = [
  ...
  "Mit jelent neked pontosan a hűség? Hol a határ?",
  "Mit jelent neked, ha szex nélkül érintelek meg?",
  "Mikor érintettelek meg utoljára úgy, hogy nem akartam semmit?",
  "Mit szeretsz magadon, amit én még nem vettem észre rajtad?",
  "Hogyan jelzed, ha valami nem jó az ágyban?",
  "Hol szeretnéd, hogy ma este először megérintselek?",
  "Mi az, amit szexuálisan kipróbálnál, de szégyelled megkérdezni?",
  "Melyik csókunk jár még a fejedben?",
  "Mit nézel rajtam, amikor azt hiszed, nem látom?",
  "Mit súgnál a fülembe holnap reggel, ha tudnád, hogy senki más nem hallja?",
  "Mit csinálsz, ha hetekig nem szeretkezünk: eltűnsz, rákérdezel, vagy duzzogsz?",
  "Mit jelent neked a flörtölés másokkal?",
  "Volt olyan, hogy igent mondtál szexre, miközben belül nemet?",
  "Hol érzed magad a legmeztelenebbnek anélkül, hogy vetkőznél?",
  "Ha egy évig nem tudnánk szeretkezni, mondjuk terhesség vagy betegség miatt, mi tartana minket össze?",
  "Hogy érjek hozzád most, ha nem kéne szégyellned?",
  "Melyik közös pillanatunkon nevetsz még most is egyedül?",
  "Mi az, amit kettőnkről tudsz, és örülsz, hogy más nem tudja?",
  "Mit kérdeznél tőlem, ha biztos lennél benne, hogy nem nevetlek ki?",
  "Hova szöknénk el egy hosszú hétvégére bejelentés nélkül?",
  "Mit jelent neked meztelennek lenni a ruhátlanságon túl?",
  "Hogyan szeretnél öregedni mellettem, ha rajtad múlna?",
