...
const ROOTS_HU: readonly string[] = [
  ...
  "Mi az a gyerekkori szégyened, amit a tested egy konkrét pontján ma is érzel?",
  "Hogyan szeretnél emlékezni anyádra, amikor már nem lesz?",
  "Karácsonykor melyik családnál ülünk majd? És aki kimarad, annak mit mondunk?",
...
const ROOTS_EN: readonly string[] = [
  ...
  "Was there a moment in your family when someone went absent emotionally, and you were left alone in the room?",
  ...
  "Who was the first death in your family you remember, and who taught you how to grieve?",
  ...
  "What's a childhood shame you still feel somewhere specific in your body?",
  "How do you want to remember your mother once she's gone?",
  "Whose family do we sit with on Christmas? And what do we say to the one we leave out?",
...
const EVERYDAY_HU: readonly string[] = [
  ...
  "Melyik álmodat tetted már most csendben félre a közös életünk kedvéért, anélkül hogy szóltál volna róla?",
...
const EVERYDAY_EN: readonly string[] = [
  ...
  "Which dream of yours have you already quietly set aside for our shared life, without saying a word?",
...
const CLOSENESS_HU: readonly string[] = [
  ...
  "Mit jelent neked pontosan a hűség, és hol húzódik nálad a határ? A gondolat, a beszélgetés, az érintés, vagy a konkrét tett?",
  ...
  "Ha egyikünk visszahúzódik a közelségből, az neked elutasítás, vagy elsőként inkább azt nézed, mi van mögötte?",
...
const CLOSENESS_EN: readonly string[] = [
  ...
  "What does faithfulness mean to you exactly, and where do you draw the line? The thought, the conversation, the touch, or only the act itself?",
  "What do we do if our desire drifts apart for a while: one of us wants more, the other less?",
...
const DEEPWATER_HU: readonly string[] = [
  ...
  "Van benned most, az esküvő előtt, akár csak egy százalék kétség? Mondjuk ki hangosan, anélkül hogy bármit jelentene.",
  "Mitől félsz jobban: hogy rossz döntés ez, vagy hogy jó döntés, és akkor felelős vagy érte?",
  "Mi a legmélyebb kudarcod eddig, és elmondtad-e már nekem egészben, nem darabokban?",
...
const DEEPWATER_EN: readonly string[] = [
  ...
  "Is there even one percent of doubt in you right now, before the wedding? Let's say it out loud, no consequences attached.",
  "Which scares you more: that this is the wrong choice, or that it's the right one and now you're responsible for it?",
  "What's your deepest failure so far, and have you told it to me whole, not in pieces?",
