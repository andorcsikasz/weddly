...
const CLOSENESS_HU: readonly string[] = [
  "Mikor szerettél belém igazán? Nem az elején, hanem amikor már tudtad.",
  "Mi az a belső poén kettőnk között, amit senki más nem ért?",
  "Melyik közös élményünk az, amit ha öregkorban felemlítek, biztos hangosan nevetni fogsz?",
  "Milyen apró szokásomat fogod megtanulni rólam, amit én magam sem veszek észre?",
  "Mit veszel észre rajtam, amit más nem szokott?",
  "Mit jelent neked, ha melléd ülök a kanapéra szó nélkül?",
  "Tudsz csendben lenni velem úgy, hogy az nem kínos, hanem teljes?",
  "Mit jelez nálad, hogy fáradt vagy, mielőtt kimondanád?",
  "Honnan ismered fel rajtam, hogy rosszul vagyok, mielőtt szóba hoznám?",
  "Mit jelent számodra az, hogy otthon? Egy hely, egy ember, egy illat?",
  "Mikor érezted utoljára, hogy egy mozdulatommal hazaértél?",
  "Milyen csendet szeretsz velem, és melyik csendem zavar?",
  "Mikor érzed magad mellettem a legbiztonságosabban?",
  "Mit szeretnél, ha kérdeznék tőled, de sosem teszem?",
  "Mi az, amit szeretnél, hogy észrevegyek rajtad, amit eddig nem mondtál ki?",
  "Mit nem mondasz el nekem, mert nem akarsz terhet rakni rám?",
  "Melyik gyerekkori történetedet mesélnéd el ma este, amit én még nem hallottam?",
  "Mi az a félelem, ami a leggyakoribb dühöd mögött bújik meg?",
  "Mi az első mondat, amit egy veszekedés után szeretnél hallani tőlem?",
  "Mit szeretnél, hogy tegyek, amikor sírsz, és nem mondasz semmit?",
  "Mi az, amit megbocsátottál nekem, de még mindig fáj?",
  ...
  "Ha öregkorban valaki megkérdezné tőlünk, mitől maradtunk legjobb barátok, mit válaszolnál először?",
  "Mi az kettőnk között, ami szeretnéd, hogy akkor is megmaradjon, ha minden más megváltozik körülöttünk?",
];
