          ...
          <div className="sticky top-20 flex max-h-[calc(100vh-6rem)] min-h-0 flex-col gap-1 overflow-y-auto [scrollbar-width:thin]">
            ...
            <div
              className={`hidden lg:flex ${
                sidebarCollapsed
                  ? "justify-center pb-1"
                  : "lg:absolute lg:right-1 lg:top-0 lg:z-10 lg:h-8 lg:items-center lg:justify-end"
              }`}
            >
              <button
                type="button"
                ...
                className="inline-flex h-7 w-7 items-center justify-center rounded-full border border-umber-900 bg-paper-50/90 text-umber-900 shadow-sm backdrop-blur-sm transition-colors hover:border-umber-900 hover:bg-umber-900 hover:text-paper-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-umber-700 focus-visible:ring-offset-2 dark:border-paper-200 dark:bg-umber-800/90 dark:text-paper-100 dark:hover:border-paper-100 dark:hover:bg-paper-100 dark:hover:text-umber-900 dark:focus-visible:ring-paper-300"
              >
                {sidebarCollapsed ? (
