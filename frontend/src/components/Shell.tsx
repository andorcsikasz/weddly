    ...
    <header className="border-b border-paper-300 bg-paper-50/80 backdrop-blur dark:border-umber-700 dark:bg-umber-900/80">
      <div className="mx-auto flex max-w-5xl items-center gap-4 px-4 py-3">
        ...
        <div className="ml-auto flex items-center gap-2">
          <LocaleSwitcher buttonClassName="inline-flex h-8 w-8 items-center justify-center rounded-md text-umber-800 transition-colors hover:bg-paper-100 hover:text-umber-900 dark:text-paper-200 dark:hover:bg-umber-800 dark:hover:text-paper-50" />
          {user ? (
