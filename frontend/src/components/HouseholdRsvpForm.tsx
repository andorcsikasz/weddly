            ...
            {calendarLinks && (
              <div className="flex flex-wrap justify-center gap-2">
                <a
                  ...
                  className="inline-flex items-center gap-1.5 rounded-full border border-paper-300 bg-paper-50 px-3.5 py-1.5 text-xs font-medium text-ink-700 transition-colors hover:border-ink-300 hover:bg-paper-100 dark:border-umber-700 dark:bg-umber-800 dark:text-paper-100 dark:hover:border-umber-500"
                >
