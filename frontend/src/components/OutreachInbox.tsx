...
// vendors. It has no page of its own: it mounts as the Megkeresések tab of
// /app/vendors/messages, reached from the message button in the /app/vendors
// top row, where sent history sits beside the replies it produced. (It used
// to also be a standalone /app/outreach page, and before that a section at
// the bottom of /app/vendors; both those URLs now redirect to the tab.)
//
// v1 scope:
...
export function OutreachInbox() {
  ...
  return (
    <section aria-labelledby="outreach-section-heading">
      <div className="mb-4 flex items-start justify-between gap-3">
        <div className="min-w-0">
          {/* The tab label already names this section, so the heading itself
              stays sr-only — it exists to keep the section's accessible name,
              not to render a second visible title. */}
          <h2 id="outreach-section-heading" className="sr-only">
            {t("outreach.heading")}
          </h2>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex shrink-0 items-center gap-2">
                            ...
                            {m.booking_id !== null && (
                              <Link
                                to={`/app/vendors/messages/${m.booking_id}`}
