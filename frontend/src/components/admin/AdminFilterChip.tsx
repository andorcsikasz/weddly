...
export function AdminFilterChip({
  ...
  const baseCls =
    "rounded-lg px-3 py-1 text-xs font-medium transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-500/40";
  const cls = active
