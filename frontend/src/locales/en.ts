...
const en: LocaleMessages = {
  ...
  planners: {
    ...
    success_body:
      "We've got your details. As soon as the planner workspace is ready, we'll reach out personally.",
    ...
    benefit_3_title: "Early access",
    benefit_3_body:
      "Waitlist planners shape the product. Early access is free in the first phase.",
