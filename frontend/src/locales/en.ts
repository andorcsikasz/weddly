...
const en: LocaleMessages = {
  ...
  landing: {
    ...
    pricing_vendor_callout_detail:
      "Three couples can reach you before anything is charged. We start earning only after Weddly has already put work in front of you, and the first month is billed from the 1st of the month after that.",
    pricing_vendor_value_note:
      "Your page stays live and editable without a subscription. Pro is what opens direct inquiries, the calendar and the client desk.",
    pricing_vendor_bullet_1: "Your first 3 couples are on us",
    pricing_vendor_bullet_2: "Your listing stays live, subscription or not",
    pricing_vendor_bullet_3: "Direct inquiries, quotes and one shared thread",
    pricing_vendor_bullet_4: "Availability calendar · two-way Google sync",
    pricing_vendor_bullet_5: "Cancel any time, your page stays up",
    pricing_vendor_cta: "List your business",
    pricing_planner_note: "Three tiers · Starter, Pro, Premium.",
