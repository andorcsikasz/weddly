...
const en: LocaleMessages = {
  ...
  wedding_site_editor: {
    ...
    cover_image_hint:
      "Paste an http(s) link to a publicly hosted image. No upload yet — this is the stop-gap until v2.",
  ...
  admin: {
    ...
    action_verify_label: "Verify",
    action_flag_label: "Flag",
    action_unflag_label: "Unflag",
  ...
  profile: {
    ...
    density_compact_help: "More fits on screen — original dense layout.",
    density_default: "Default",
    density_default_help: "Balanced sizing — comfortable to read, little extra real estate lost.",
    density_comfortable: "Comfortable",
    density_comfortable_help: "Larger small labels — good for parents and helpers.",
