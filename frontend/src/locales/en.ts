...
const en: LocaleMessages = {
  ...
  planners: {
    ...
    label_years: "How many years have you been a wedding planner?",
    label_website: "Website",
    placeholder_website: "e.g. yoursite.com",
    label_weddings_per_year: "Approx. how many weddings per year?",
    placeholder_weddings_per_year: "e.g. 12",
    label_usage: "What would you use it for most?",
    usage_guestlist: "Guest list management",
    usage_seating: "Seating plan",
    usage_tasks: "Task management",
    usage_all: "All three equally",
