...
const en: LocaleMessages = {
  ...
  landing: {
    ...
    pricing_amount: "Free",
    pricing_amount_sub: "for the first 200 couples",
    pricing_after: "then 5 € / month, with a 2-week free trial",
    pricing_bullet_1: "Free until your wedding, up to 18 months",
