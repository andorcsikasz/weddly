...
const en: LocaleMessages = {
  common: {
    ...
    decrement: "Decrement",
    undo: "Undo",
    last_updated_by: "Last updated by {name}, {when}",
  ...
  seo: {
    ...
    messages_title: "Messages · Weddly",
    messages_description:
      "Your conversations with the vendors you contacted: quotes, questions and answers in one place.",
  },
  a11y: {
    close: "Close",
  ...
  auth: {
    ...
    register_role_prompt: "Not a couple?",
    register_as_vendor: "As a vendor",
    register_as_planner: "As a planner",
  ...
  billing: {
    ...
    terms_accept_link: "subscription terms",
    terms_accept_suffix: ".",
    ...
    grace_banner_title: "Your trial has ended.",
    grace_banner_body:
      "Invite your partner and you are our guests until your wedding day, or add payment details by {date} to keep editing.",
    grace_banner_cta: "Invite partner",
    grace_banner_pay: "Add payment details",
    ...
    referral_couple_reward: "1 month free",
    referral_vendor_reward: "2 months free",
  ...
  wedding_site_editor: {
    ...
    cover_image_remove: "Remove cover image",
    cover_drop_hint: "Drag an image here, or pick a file above",
    cover_drop_active: "Drop to upload",
    cover_position_hint: "Drag the image to reposition it",
    save_button: "Save",
    save_saving: "Saving…",
  ...
  vendor_activate: {
    ...
    founding_note: "The first {cap} vendors are our guests for a full year.",
    early_badge: "Early access · {left}/{cap} spots left",
    early_note: "{cap} vendors are our guests for three months, and there are still spots open.",
  ...
  vendor_home: {
    ...
    name_locked_until: "The brand name can change once a week. Next change: {date}.",
    name_change_warning: "Once saved, the brand name stays fixed for {days} days.",
    name_change_confirm: "Save name",
    ...
    gallery_position_hint: "Drag to reframe",
    ...
    packages_currency_label: "Price currency",
    packages_currency_reset: "Use country default",
    packages_currency_saved: "Price currency saved.",
    packages_currency_failed: "Could not save the currency, please try again.",
    packages_price_mode_label: "Price type",
    packages_price_mode_total: "Total price",
    packages_price_mode_per_person: "Price / person",
    packages_price_min_label: "Minimum price",
    packages_price_max_label: "Maximum price (optional)",
    packages_price_equivalent: "Estimated equivalent: {price}",
    packages_price_range_invalid: "The minimum price cannot exceed the maximum.",
    packages_legacy_price: "Current price: {price}",
    packages_legacy_remove: "Remove old price",
    packages_desc_label: "Description",
  ...
  vendor: {
    ...
    points: {
      ...
      to_next_reviews: "{n} more reviews to {tier}",
      to_next_profile: "Finish your listing to reach {tier}",
      at_top: "You're at the top tier",
      ladder_label: "Tiers",
      ladder_start: "Starting tier",
      ladder_req: "{points} points · {reviews} reviews",
      gap_title: "To reach {tier}",
      gap_points: "Points",
      gap_reviews: "Reviews",
      gap_profile: "Completed listing",
      tier: {
        blue: "Blue",
        gold: "Gold",
        platinum: "Platinum",
      ...
      earn_profile_completeness: "Complete your listing, for every 25%",
      earn_first_review: "Get your first review",
      earn_review_collected: "Collect a review from a couple",
      earn_fast_reply: "Answer an inquiry within {hours} hours",
      earn_booking_confirmed: "A couple books you through Weddly",
      earned_so_far: "{n} so far",
      next_unlocks: "At {tier}:",
      rank_position: "#{rank} of {total} in {category}",
      rank_gap: "{points} points to move up",
    },
    dashboard: {
      ...
      greeting: {
        ...
        midday: "Ready for the day, {name}?",
        afternoon: "Good afternoon, {name}",
        early_evening: "Hello, {name}",
        evening: "Good evening, {name}",
        night: "Welcome to the night shift, {name}",
        christmas: "Merry Christmas, {name}",
        new_year: "Happy New Year, {name}",
        valentines: "Happy Valentine's Day, {name}",
        easter: "Happy Easter, {name}",
      },
      inquiries_total: "Total inquiries",
      inquiries_30d: "Last 30 days",
      views_30d: "Profile views (30 days)",
      revenue_tracked: "Revenue tracked",
      blocked_dates: "Blocked dates",
      upcoming_title: "Upcoming events",
      no_upcoming:
        "No confirmed weddings yet. Every one of them starts with a couple finding your page.",
    ...
    clients: {
      ...
      empty_cta_share: "Share your listing",
      ...
      thread_locked_title: "Reply to your clients",
      thread_locked_body:
      ...
      deposit_exceeds_contract: "The deposit cannot be higher than the contract value.",
      balance: "Balance",
      ...
      status_confirm_title: "Change the status to {status}?",
      status_confirm_body:
        "The change is saved immediately, is visible to the couple, and may change this date's availability.",
      status_confirm_action: "Change status",
      save: "Save changes",
      saving: "Saving…",
      saved: "Client updated.",
      save_failed: "Couldn't save, please try again.",
      load_failed: "We couldn't load this client.",
      quick_look: "Quick look at {name}",
      clear_filters: "Clear filters",
      status_changed: "Marked {status}.",
      undo_failed: "Couldn't undo that. Try again.",
    },
    stage: {
      inquiry: "Inquiry",
      quoted: "Quoted",
      ...
      aria: "Booking progress: {stage}",
      aria_closed: "Booking closed: {status}",
      hold_live: "Date on hold",
    },
    next: {
      title: "Next step",
      action_open: "Open the inquiry",
      action_reply: "Reply",
      action_follow_up: "Follow up",
      action_await: "Waiting on the couple",
      action_record_contract: "Record the agreed price",
      cta_record_contract: "Enter price",
      action_add_schedule: "Add a payment schedule",
      action_chase_payment: "Chase the payment",
      action_release_or_extend: "Release or extend the date",
      action_request_review: "Ask for a review",
      action_prepare: "Booked",
      action_none: "Nothing to do",
      hint_open: "You haven't looked at this one yet.",
      hint_reply: "The couple is waiting to hear from you.",
      hint_follow_up: "It has gone quiet since you wrote.",
      hint_await: "You've answered. Nothing to do until they come back.",
      hint_record_contract: "Put the agreed amount on the booking so the balance is right.",
      hint_add_schedule: "Split the amount into installments you can track.",
      hint_chase_payment: "An installment is past its due date.",
      hint_release_or_extend: "Your hold on this date runs out shortly.",
      hint_request_review: "The wedding is done. A review takes them two minutes.",
      hint_prepare: "Booked, nothing outstanding.",
      hint_none: "This inquiry is closed.",
    },
    assistant: {
      title: "Assistant",
      intro: "A summary of this inquiry, what the couple left out, and a reply to edit.",
      ai_disclosure:
        "Uses Anthropic AI. Clicking Read sends the inquiry and limited event/package context to Anthropic; no message is sent automatically.",
      privacy_link: "Privacy details",
      generate: "Read this inquiry",
      regenerate: "Read it again",
      working: "Reading…",
      unavailable: "No answer just now. Try again in a moment.",
      summary_title: "The inquiry",
      missing_title: "They did not say",
      package_title: "Package that fits",
      no_packages: "You have no saved packages yet, so there is nothing to suggest.",
      no_package_fit: "None of your saved packages fits this one.",
      draft_title: "Draft reply",
      ai_draft_title: "AI-assisted draft reply",
      draft_note: "A draft. Nothing has been sent. Edit it, then send it yourself in the thread.",
      copy: "Copy",
      copied: "Draft copied.",
    ...
    attention: {
      ...
      snooze: "Not now",
      snoozed: "{name} muted for a week.",
      snooze_failed: "Couldn't mute this one, please try again.",
      more: "and {count} more",
      age_hours: "{count}h",
      age_days: "{count}d",
      reason_unopened: "New, unopened for {age}",
      reason_unanswered: "Waiting for your reply for {age}",
      reason_hold_expiring: "Date hold runs out in {count}h",
      reason_payment_overdue: "Payment overdue by {age}",
      reason_date_soon: "Wedding in {count}d, still open",
      reason_going_cold: "Quiet for {age} since you wrote",
      reason_review_due: "Wedding is over, no review yet",
    },
    payments: {
    ...
    quotes: {
      ...
      title_field: "Quote name",
      title_placeholder: "Full day coverage",
      line_label: "Item",
      line_placeholder: "Ceremony coverage",
      line_qty: "Qty",
      line_amount: "Unit price",
      line_add: "Add line",
      line_remove: "Remove line",
      deposit_field: "Deposit",
      valid_until_field: "Valid until",
      message_field: "Message",
      message_placeholder: "A few lines the couple reads beside the numbers.",
      required_hint: "Fields marked with * are required before the quote can be saved.",
      saved: "Quote saved.",
      save_failed: "Couldn't save the quote.",
      send: "Send",
      sent: "Quote sent.",
      send_failed: "Couldn't send the quote.",
      withdraw: "Withdraw",
      withdrawn: "Quote withdrawn.",
      withdraw_failed: "Couldn't withdraw the quote.",
      withdraw_confirm_title: "Withdraw this quote?",
      withdraw_confirm_body: "The couple keeps the card, but can no longer answer it.",
      remove: "Delete",
      removed: "Quote deleted.",
      remove_failed: "Couldn't delete the quote.",
      remove_confirm_title: "Delete this draft?",
      remove_confirm_body: "A draft has not been sent, so nobody else has seen it.",
      not_draft: "A sent quote stays as it is. Withdraw it and write a new one.",
      pro_required: "Quotes are part of PRO.",
      locked_title: "Send a priced offer",
      locked_body: "Price an inquiry line by line and let the couple accept it in one tap.",
    },
    holds: {
      title: "Date hold",
      intro:
        "Take this date off your calendar for this couple while they decide. It lets itself go when the time is up, so nothing is left blocked by accident.",
      empty: "This date is not on hold.",
      for_date: "Holding {date}",
      state_live: "On hold, {remaining} left",
      state_expired: "The hold ran out on {date}",
      state_released: "You released this date on {date}",
      duration_label: "Hold for",
      duration_hours: "{count} hours",
      duration_days: "{count} days",
      expires_preview: "Expires: {date}",
      calendar_effect:
        "While the hold is active, this date appears unavailable to other couples. The couple this hold belongs to can still proceed with their booking.",
      place: "Hold the date",
      extend: "Extend",
      release: "Release",
      release_confirm_title: "Release this date?",
      release_confirm_body: "It goes back on your public calendar straight away.",
      placed: "Date held.",
      extended: "Hold extended.",
      released: "Date released.",
      failed: "Couldn't update the hold, please try again.",
      no_date: "This couple has no fixed date yet, so there is nothing to hold.",
      date_past: "That date has already passed.",
      booking_closed: "This inquiry is closed, so the date is free anyway.",
      locked_title: "Hold a date while they decide",
      locked_body:
        "Keep one date for one couple, with a deadline that looks after itself. Part of PRO, like your availability calendar.",
    },
    stats: {
      page_title: "Stats",
      ...
      views: "Profile views",
      views_help:
        "How many times couples opened your profile. Appearing in a directory list doesn't count, only a real open.",
      views_recent: "{n} in the last 30 days",
    ...
    revenue: {
      title: "Revenue pulse",
      body: "What is in flight, and what lands next.",
      booked: "Booked",
      booked_help:
        "The agreed value of your confirmed bookings. Money already won, whether or not it has arrived.",
      collected: "Collected",
      outstanding: "Still to collect",
      pipeline: "Open pipeline",
      pipeline_help:
        "The value you have quoted on leads that are still undecided. Not a forecast, only what is on the table.",
      weighted: "Weighted",
      weighted_help:
        "The open pipeline discounted by how often a lead at each stage becomes a booking. An estimate, not a promise: your own win rate is below, so you can judge it yourself.",
      estimate: "Estimate",
      unpriced_note: "Leads with no recorded value are left out ({n}).",
      booked_unpriced_note: "Confirmed bookings with no recorded value are left out ({n}).",
      upcoming_title: "Landing next",
      next_30: "Next 30 days",
      next_60: "Next 60 days",
      next_90: "Next 90 days",
      average_booking: "Average booking",
      win_rate: "Win rate",
      trailing_note: "Over {n} decided leads in the last {days} days.",
      see_breakdown: "Breakdown",
    },
    reviews: {
      page_title: "Reviews",
    ...
    billing: {
      ...
      add_card_body:
        "Save a card to stay on Pro through your first {total} direct inquiries. Saving it creates no payment obligation and we never charge it automatically. After those inquiries, choose Subscribe to continue Pro.",
    ...
    settings: {
      ...
      tab_schedule: "Working hours",
      tab_automations: "Automations",
    },
    automations: {
      intro:
        "Three things we can handle for you. Each one switches on separately, and all three start off.",
      locked:
        "Automations are part of the PRO plan. Your switches and your text stay exactly where they are, they simply pause until the subscription is back.",
      saved: "Saved",
      save_failed: "That didn't save",
      toggle_aria: "Turn {name} on or off",
      ack_title: "Instant acknowledgement",
      ack_body:
        "The moment an inquiry lands, we send the couple your own words, so they are not left in silence while you get to them.",
      ack_template_label: "Which template goes out?",
      ack_template_none: "Nothing selected",
      ack_no_templates:
        "Write the text first. An empty auto-reply is worse than none, so this stays off until there is something to send.",
      ack_templates_link: "Edit your templates",
      ack_needs_body: "Pick the text that should go out first.",
      ack_note:
        "The couple sees it in the conversation too, marked as sent automatically, so your real answer never reads as a repeat.",
      reminder_title: "Reminder about unanswered inquiries",
      reminder_body:
        "When a couple is still waiting on you, we email you. This one only ever reaches you, never the couple.",
      reminder_delay_label: "After this many hours of waiting",
      reminder_delay_hint: "Between {min} and {max} hours.",
      review_title: "Post-wedding review request",
      review_body:
        "After the wedding we prepare the request, and it only goes out once you approve it. It asks for stars in your name, so it stays your call.",
      proposals_title: "Waiting for your approval",
      proposals_empty: "Nothing is waiting for your approval right now.",
      approve: "Send it",
      dismiss: "Not this one",
      approved: "Sent",
      dismissed: "Fine, we won't send it",
      action_failed: "That didn't work",
      activity_title: "What has run so far",
      activity_empty: "Nothing has run yet.",
      status_sent: "Sent",
      status_proposed: "Waiting for approval",
      status_approved: "Approved and sent",
      status_dismissed: "Dismissed",
      status_skipped: "Skipped",
      detail_opted_out: "the recipient asked us not to write to them",
      detail_send_failed: "the email did not go out",
      key_inquiry_ack: "Instant acknowledgement",
      key_unanswered_reminder: "Reminder",
      key_review_request: "Review request",
    },
    schedule: {
      intro: "These hours repeat every week. Couples only see which days you work.",
      name_label: "Schedule name",
      name_placeholder: "Working hours",
      from: "From",
      to: "To",
      add_interval: "Add another block",
      remove_interval: "Remove this block",
      add_day: "{day}: add working hours",
      copy_to: "Copy to other days",
      copy_title: "Copy times to",
      copy_apply: "Apply",
      day_on_action: "Mark as a working day",
      day_off_action: "Mark as a day off",
      need_one_day: "Keep at least one working day, or you drop out of every search.",
      saved: "Working hours saved",
      save_failed: "Could not save your working hours",
      up_to_date: "Saved",
      exceptions_title: "Exceptions",
      exceptions_intro: "A single date that differs from the weekly schedule.",
      exceptions_empty: "No exceptions.",
      exception_add: "Add exception",
      exception_date: "Date",
      exception_kind_label: "Which way the exception goes",
      exception_kind_off: "Not working",
      exception_kind_on: "Working",
      exception_scope_label: "Whole day or hours",
      exception_all_day: "All day",
      exception_hours: "Certain hours",
      exception_on_hint: "You work this date even though the weekly schedule has that day off.",
      exception_on_label: "Working",
      exception_off_label: "Busy all day",
      exception_off_hours_label: "Busy {from}-{to}",
      exception_saved: "Exception saved",
      exception_removed: "Exception removed",
      exception_failed: "Could not save the exception",
      ...
      gcal_pull_label: "Respect the busy time in my Google Calendar",
      gcal_privacy: "Only busy time slots are read, never event titles or attendees.",
      gcal_primary: "Primary",
      gcal_saved: "Setting saved",
  ...
  vendor_calendar: {
    ...
    legend_hold: "Date on hold",
    hold_label: "On hold for {name} · {remaining} left",
    ...
    tasks_empty:
      "Nothing on the board yet. Anything you give a deadline also lands on the calendar.",
    tasks_empty_cta: "Add a task",
    board_todo: "To do",
  ...
  outreach: {
    ...
    compose_title: "Send inquiry",
    tpl_overwrite_title: "Replace what you wrote?",
    tpl_overwrite_body: "The template overwrites the subject and message you have typed.",
    tpl_overwrite_confirm: "Replace",
    ...
    err_supplier_no_contact:
      "One or more vendors asked not to be contacted through Weddly. Reach out to them directly.",
  ...
  thread: {
    ...
    attach_hint: "PDF or JPG, up to 6 MB",
    remove_file: "Remove file",
    templates: "Templates",
    templates_manage: "Manage templates",
    templates_empty: "No templates yet. Write your first one below.",
    template_title: "Title",
    template_body: "Message",
    template_vars: "Insert:",
    template_add: "Add template",
    template_update: "Save changes",
    template_cancel: "Cancel",
    template_saved: "Template saved.",
    template_save_failed: "Couldn't save, please try again.",
    template_delete_title: "Delete this template?",
    template_delete_confirm: "Delete",
    var_client_name: "Client name",
    var_event_date: "Event date",
    var_vendor_name: "Your name",
    status_sent: "Sent",
    status_delivered: "Delivered",
    status_seen: "Seen",
    attachment_failed: "Couldn't open the file, please try again.",
    send_failed: "Couldn't send, please try again.",
    too_many_files: "Up to {max} files per message.",
    file_too_large: "{name} is larger than 6 MB.",
    unsupported_file: "{name} is not a PDF or a JPG.",
  },
  booking_timeline: {
    event_inquiry_sent: "Inquiry received for {date}",
    event_inquiry_sent_nodate: "Inquiry received",
    event_vendor_opened: "Inquiry opened",
    event_vendor_responded: "Inquiry answered",
    event_booking_confirmed: "Booking confirmed",
    event_booking_declined: "Inquiry declined",
    event_booking_cancelled: "Booking cancelled",
    event_booking_expired: "Inquiry expired",
    event_quote_sent: "Quote sent: {label} · {amount}",
    event_quote_viewed: "Quote opened: {label}",
    event_quote_accepted: "Quote accepted: {label} · {amount}",
    event_quote_declined: "Quote declined: {label}",
    event_quote_withdrawn: "Quote withdrawn: {label}",
    event_hold_placed: "Date held: {date}",
    event_hold_released: "Date hold released: {date}",
    event_hold_expired: "Date hold expired: {date}",
    event_payment_scheduled: "Installment scheduled: {label} · {amount}",
    event_payment_paid: "Installment paid: {label} · {amount}",
    event_automation_ran: "Automation ran: {name}",
    automation_inquiry_ack: "Inquiry acknowledgement",
    automation_unanswered_reminder: "Unanswered inquiry reminder",
    automation_review_request: "Review request",
    automated: "Automatic",
    automated_hint: "An automation sent this message.",
  },
  messages: {
    page_title: "Messages",
    ...
    open_thread_aria: "Conversation with {name}",
  ...
  quotes: {
    ...
    accept: "Accept",
    decline: "Decline",
    decline_title: "Decline this quote",
    decline_label: "Reason",
    decline_placeholder: "Optional, and the vendor reads it.",
    accepted: "Quote accepted.",
    declined: "Quote declined.",
    answer_failed: "Couldn't send your answer.",
    not_answerable: "This quote is no longer open.",
  },
  change_email: {
  ...
  onboarding: {
    ...
    ceremony_kind_question: "Ceremony type",
  ...
  dashboard: {
    ...
    greeting: {
      ...
      midday: "Ready for the day, {name}?",
      afternoon: "Good afternoon, {name}",
      early_evening: "Good to see you, {name}",
      evening: "Good evening, {name}",
      night: "Still up, {name}?",
      christmas: "Merry Christmas, {name}",
      new_year: "Happy New Year, {name}",
    ...
    kpi_days_elapsed_progress: "{elapsed} days elapsed · {left} to go",
    kpi_guests_label: "RSVPs in",
    kpi_guests_unit: "of {total} invited replied",
  ...
  landing: {
    ...
    demo_vendors_title: "Now the names.",
    demo_vendors_body: "{n} vendors in the directory, from venues to photographers.",
    demo_vendors_body_plain: "Venues, photographers, decor, music, in one directory.",
    demo_vendors_cta: "Sign up and see them all",
    demo_vendors_browse: "Or look around without signing up",
    ...
    card_vendors_title: "For suppliers",
    card_vendors_body:
      "Get listed in our curated directory and reach couples who are planning right now.",
    card_vendors_cta: "List your business",
    card_planners_title: "For planners",
    card_planners_cta: "Manage every couple",
    ...
    suppliers_search_all: "All suppliers",
    suppliers_search_count: "{n} suppliers",
    suppliers_search_count_one: "1 supplier",
    ...
    footer_tagline: "Low-cortisol wedding planning, with one live plan for both of you.",
    ...
    footer_couples_guestlist: "Guest list template",
    ...
    provendors_title: "Your first year of Weddly Pro as Vendor is on us",
    ...
    pricing_vendor_note: "Monthly, cancel any time — or annually, at 25% off.",
    pricing_vendor_callout: "Your first 3 couples are on us.",
    pricing_vendor_callout_detail:
      "Every Pro feature stays open until three couples reach you. After that you subscribe with one click — nothing is ever auto-charged, and paying annually saves you 25%.",
    pricing_vendor_value_note:
      "Your page stays live and editable without a subscription. Pro only unlocks what earns you money: direct inquiries, the calendar, the client desk.",
    pricing_vendor_bullet_1: "Your first 3 couples are on us",
    pricing_vendor_bullet_2: "Your listing stays live, forever, subscription or not",
    pricing_vendor_bullet_3: "Direct inquiries and quotes in one shared thread",
    pricing_vendor_bullet_4: "Live calendar, two-way Google sync — no double bookings",
    pricing_vendor_bullet_5: "Pay annually, save 25% on Pro",
    pricing_vendor_cta: "List your business",
    pricing_planner_note: "Three tiers · Starter, Pro, Premium. Save 25% annually.",
    pricing_planner_callout: "Come in early, your first 2 years are on us.",
    pricing_planner_callout_detail:
      "We're still building the planner desk alongside the studios using it. Join while that's true and your tier is on us for two years, everything unlocked.",
    pricing_planner_value_note:
      "Starter carries your first clients; Pro and Premium raise the ceiling as the studio grows.",
    pricing_planner_bullet_1: "Every wedding you run, in one workspace",
    pricing_planner_bullet_2: "A public profile in the planner directory",
    pricing_planner_bullet_3: "Budget, guests, seating and timeline per client",
    pricing_planner_bullet_4: "Weddly Points: rank higher as you deliver",
    pricing_planner_bullet_5: "Monthly · cancel any time",
    pricing_planner_cta: "Set up your studio",
  ...
  vendors: {
    ...
    form_success_body:
      "We aren't onboarding suppliers yet, we've sent a confirmation to the email you provided, and we'll write again once we open in your category.",
    ...
    contact_subject: "Supplier waitlist",
    ...
    beta_notice_terms_link: "Supplier subscription terms",
    ...
    demo_cta: "See the demo",
    demo_loading: "One moment…",
    demo_error: "Couldn't start. Try again.",
    pitch_manage_eyebrow: "Manage",
    pitch_manage_title: "Every inquiry and every date, in one place.",
    pitch_manage_b1: "Inquiries land in one client list, each with its next step.",
    pitch_manage_b2: "Set your weekly hours, block days, add setup and teardown time.",
    pitch_manage_b3: "Hold a date for a couple while they decide.",
    pitch_grow_eyebrow: "Grow",
    pitch_grow_title: "Be there when couples choose.",
    pitch_grow_b1:
      "Couples plan their guest list, budget and timeline here, then pick from a short list.",
    pitch_grow_b2: "Your photos, packages and reviews on one page.",
    pitch_grow_b3: "Your email address stays private. Couples write to you through Weddly.",
    pitch_book_eyebrow: "Get booked",
    pitch_book_title: "From quote to confirmed date.",
    pitch_book_b1: "Send an itemised quote with an expiry date.",
    pitch_book_b2: "When the couple accepts, the date is confirmed.",
    pitch_book_b3: "Track deposits and balances for every client.",
    pitch_mock_booked: "Booked",
    pitch_mock_held: "Held",
    pitch_mock_new_inquiry: "New inquiry",
    pitch_mock_reply: "Reply",
    pitch_mock_quote: "Quote",
    pitch_mock_accepted: "Accepted",
    pitch_mock_line_1: "Full day",
    pitch_mock_line_2: "Setup and teardown",
    pitch_mock_line_3: "Extra hour",
    pitch_mock_total: "Total",
    pitch_mock_deposit: "Deposit",
    pitch_mock_balance: "Balance",
    pitch_mock_paid: "Paid",
    pitch_mock_due: "Due",
    pitch_trades_title: "Built for every wedding trade.",
    pitch_trades_cta: "Browse the directory",
    pitch_faq_title: "Good to know",
    pitch_faq_1_q: "My business is already listed. How do I take it over?",
    pitch_faq_1_a:
      "Search for it at the top of this page. If a listing exists, you claim it, and the confirmation goes to the business's own contact address.",
    pitch_faq_2_q: "Can couples see my email address?",
    pitch_faq_2_a:
      "No. Couples write to you through Weddly, and you answer from your client list. Your address is never shown.",
    pitch_faq_3_q: "Do I have to publish my calendar?",
    pitch_faq_3_a:
      "No. Switch it off and couples see no dates, but they can still send you an inquiry. Switch it back on and nothing you entered is lost.",
    pitch_faq_4_q: "Does it work in my language?",
    pitch_faq_4_a:
      "Weddly comes in English, Hungarian, Spanish, Croatian and German. Your listing has room for a description in your own language and one in English, and each couple reads the one that fits.",
    pitch_faq_5_q: "Who is it for?",
    pitch_faq_5_a:
      "Any business that works on weddings, from venues and caterers to photographers, florists and bands. Wedding planners have their own page.",
    pitch_faq_6_q: "Can I look around before I sign up?",
    pitch_faq_6_a:
      "Yes. The demo is a supplier account with sample clients, so you can click through everything first.",
  },
  vendor_register: {
    err_listing_exists:
    ...
    seo_title: "Become a supplier · Wēddly",
    seo_description:
      "Create your Wēddly supplier profile and reach couples planning their wedding right now.",
    title: "Create your supplier account",
    subtitle: "List your business on Wēddly and reach couples planning right now.",
    step_account: "Account",
    step_business: "Business",
    email_required: "Please enter your email address.",
    business_name_label: "Display name",
    optional_details_toggle: "Company & contact details",
    optional_details_hint: "Optional. You can add these during onboarding.",
    business_name_help: "This is what couples see on your listing — your brand name.",
    business_name_required: "Please enter your business name.",
    company_name_label: "Company name (official)",
    company_name_help:
      "Your legal company name. Shown small, under the brand name on your profile.",
    ...
    legal_accept_prefix: "I have read and expressly accept the",
    legal_accept_link: "Vendor subscription terms (ÁSZF)",
    legal_accept_suffix: "and acknowledge the Privacy Notice.",
    highlighted_accept:
  ...
  vendor_onboarding: {
    ...
    phone_label: "Phone",
    phone_placeholder: "+44 20 7123 4567",
    phone_invalid: "That doesn't look like a phone number.",
    website_label: "Website",
    website_placeholder: "example.com",
    website_invalid: "That doesn't look like a website.",
    ...
    empty_title: "Go live without a photo?",
    empty_body: "You'll show up as an empty card in the couples' list.",
    empty_upload: "I'll add one",
    skip: "Skip",
  ...
  planning: {
    ...
    decisions: {
      ...
      progress_scope_hint:
        "Personalization answers tailor this list; they are not counted as decisions.",
    ...
    selection_toolbar: "Selected item actions",
    select_all: "Select all",
    clear_selection: "Clear selection",
    selected_count_one: "{count} selected",
    selected_count_other: "{count} selected",
    item_select: "Select {title}",
    bulk_delete: "Delete selected",
    bulk_delete_confirm_title_one: "Delete {count} item?",
    bulk_delete_confirm_title_other: "Delete {count} items?",
    bulk_delete_confirm_body:
      "The selected items will be permanently deleted. This cannot be undone.",
    bulk_delete_success_one: "{count} item deleted",
    bulk_delete_success_other: "{count} items deleted",
    ...
    checklist: {
      ...
      only_remaining: "Only remaining tasks",
      download_action: "Download PDF",
      add_action: "Add to my to-dos",
      add_error: "Couldn't add that item. Please try again.",
      save_error: "Couldn't save that change. Please try again.",
  ...
  notifications: {
    ...
    rsvp_guest_message: "{household} left you a message",
    ...
    vendor_message: "{vendor} replied",
    vendor_quote: "{vendor} sent a quote",
    rsvp_yes: "yes",
    rsvp_no: "no",
    rsvp_maybe: "maybe",
    ...
    planning_decisions_stale_group: "{count} decisions waiting: {group}",
    planning_decisions_stale_multi: "{count} decisions waiting across {groups} themes",
  ...
  timeline: {
    ...
    gcal_disconnect_title: "Disconnect Google Calendar?",
    gcal_disconnect_body:
      "We'll remove the Weddly calendar from your Google account. Your tasks stay safe here in Weddly.",
    gcal_disconnect_confirm: "Disconnect",
    gcal_menu_aria: "Google Calendar options",
    gcal_toast_connected: "Google Calendar connected. Your tasks are syncing.",
    gcal_toast_synced: "Synced to Google Calendar.",
    gcal_toast_disconnected: "Google Calendar disconnected.",
    gcal_toast_error: "Couldn't connect Google Calendar. Please try again.",
    gcal_toast_denied: "Google Calendar connection was cancelled.",
  ...
  honeymoon: {
    ...
    // Short noun form, matching flight_short ("Flights") — fills the same
    // third-of-a-390px-tile slot; the full CTA lives in edit_dates as the
    // tile's accessible action label.
    set_dates_cta: "Dates",
  ...
  media: {
    ...
    film_settings_upload: "Upload rules",
    ...
    film_collapse: "Collapse cover photo",
    film_expand: "Expand cover photo",
    ...
    film_no_participants: "No guests have joined the photo upload yet.",
    ...
    film_rotate_link: "Revoke guest link",
    film_rotate_link_body:
      "The old guest link, custom link, and every printed QR code will stop working immediately. You will need to share the new link and QR code again.",
    film_rotate_link_confirm: "Revoke and create new link",
    film_rotate_link_done: "Your new guest link is ready.",
    film_email_guests: "Email guests their photos",
    film_email_guests_body:
      "Every contributing guest with an email on file gets a link to the gallery. Guests already emailed won't get a repeat.",
    film_email_guests_confirm: "Send",
    film_email_guests_done: "Sent to {{n}} guests.",
    film_email_guests_none: "Everyone with photos has already been emailed.",
    ...
    film_participants_joined: "{{n}} guests joined the photo upload",
    ...
    gallery_from_you: "You",
    gallery_dialog_label: "Photo viewer",
    gallery_photo_alt: "Photo {n}, uploaded by {name}, {date}",
    gallery_download: "Download",
    gallery_prev: "Previous photo",
    gallery_next: "Next photo",
    photo_delete: "Delete photo",
    photo_delete_title: "Delete photo",
    photo_delete_body: "This photo will be removed from the film for you and your guests.",
    photo_delete_confirm: "Delete",
    photo_deleted: "Photo deleted",
  },
  photos: {
    not_found: "This link is gone.",
    not_found_sub: "Ask the couple for the latest QR code.",
    uploads_disabled: "The film is closed.",
    uploads_disabled_sub: "No more photos are being collected.",
    busy: "One moment.",
    busy_sub: "A lot of guests are joining at once. Try again in a few seconds.",
    busy_retry: "Try again",
    name_heading: "What's your name?",
    name_placeholder: "Your name",
    name_continue: "Start shooting",
    limit_heading: "That's a wrap.",
    limit_sub: "All {{n}} of your shots are in. Thank you.",
    ...
    error_heic:
      "HEIC/HEIF cannot be uploaded yet. In iPhone Photos, share or export it as JPEG, then choose it again.",
    error_generic: "Something went wrong. Please try again.",
    take_photo: "Take a photo",
    upload_existing: "Upload a photo",
    flip_camera: "Flip camera",
    camera_blocked: "Camera is off",
    camera_blocked_sub: "Allow camera access, or tap to pick a photo.",
    camera_blocked_inapp: "Open this link in Safari, or tap to pick a photo.",
    sent_heading: "Got it.",
    sent_sub_reveal: "{{names}} see it on {{date}}, with everyone else's.",
    sent_sub_now: "{{names}} will see it in a moment.",
    sent_count: "{{n}} shots from you",
    sent_add_more: "Take another",
    sent_invite: "Tell the others",
    welcome_back_heading: "Hey {{name}}.",
    welcome_back_sub_one: "One shot in. Got another good moment?",
    welcome_back_sub_many: "{{n}} shots in. Got another good moment?",
    welcome_back_cta: "Open camera",
    developing_heading: "Still developing.",
    developing_sub: "{{names}} open every guest's photos together on {{date}}.",
    gallery_count: "{{n}} photos",
    guest_subtitle: "Wedding film · {{date}}",
    guest_subtitle_plain: "Wedding film",
    preview_banner: "Host preview · uploads disabled",
    preview_camera_heading: "Camera preview",
    preview_camera_sub: "Camera access and live uploads are disabled in this preview.",
    preview_continue: "Preview camera",
    preview_unavailable: "Preview unavailable.",
    preview_unavailable_sub: "Sign in to the workspace that owns this film.",
    from_couple: "From the couple",
    email_placeholder: "Your email",
    email_hint:
      "So we can send you your own photos later, and tell you apart from anyone else here.",
    email_invalid: "That email doesn't look right.",
    marketing_opt_in_label: "Email me occasional Weddly news too.",
    privacy_link: "Privacy",
    sent_toast: "Sent",
    invite_aria: "Invite others to shoot",
    queue_retry: "Tap to retry",
    landing_heading: "Capture the day with us.",
    landing_body:
      "Help us catch the moments we'd miss — happy tears, quiet jokes, the dance floor at 1am.",
    landing_cta: "Open camera",
    landing_reassure_no_app: "No app needed",
    landing_reassure_no_account: "No account needed",
    landing_reassure_private: "Private to this wedding",
    prompt_1: "Catch the happiest laugh you see.",
    prompt_2: "Take a photo with someone you haven't spoken to yet.",
    prompt_3: "Find the best dance move on the floor.",
    prompt_4: "Capture a tiny detail you love about today.",
    prompt_5: "Take a photo of the couple without them noticing.",
    prompt_6: "Snap something that makes you smile right now.",
    prompt_7: "Find the best-dressed guest in the room.",
    prompt_8: "Capture a quiet moment nobody else is looking at.",
  },
  design: {
    title: "Design",
    ...
    web: {
      ...
      photo_art: {
        ...
        place_setting: "Table setting",
        greenery_arch: "Greenery arch",
        draped_arch: "Draped arch",
        pampas_candles: "Pampas and candlelight",
        candle_still: "Candlelight",
  ...
  guest_page_editor: {
    ...
    addon_pending_title: "Payment received",
    addon_pending_body:
      "Your add-on is paid. Your planner now needs to switch on guest-page editing for you.",
    ...
    venue_map_label: "Show the venue on a map",
  ...
  wishlist_editor: {
    ...
    title_label: "Title",
    title_placeholder: "e.g. A handwritten letter, old photos, a weekend away",
    kind_label: "Type",
    kind_gift: "Gift",
    ...
    add_gift: "Gift",
    add_request: "Request",
    add_first_gift: "Add the first one",
    add_first_request: "Note down the first one",
    count_gifts: "{count} gifts",
    count_requests: "{count} requests",
    count_received: "{count} received",
    open_link: "Open {host} in a new tab",
    gifts_empty: "No gifts on the list yet.",
    requests_empty: "What would mean a lot to you?",
    ...
    url_preview_miss: "No image found for this link, so we used the shop's own mark.",
    icon_label: "Icon",
    icon_choice: {
      Gift: "Gift",
      House: "Home",
  ...
  quiz: {
    list: {
      title: "Quiz",
      subtitle:
        "Build a live trivia round about the two of you and play it together at the reception.",
      new_button: "New quiz",
      create_prompt_label: "Quiz name",
      create_placeholder: "e.g. How well do you know us?",
      create_submit: "Create",
      create_cancel: "Cancel",
      empty_title: "No quizzes yet",
      empty_body: "Create one and start adding questions.",
      status_draft: "Draft",
      status_live: "Live",
      status_ended: "Ended",
      ...
      edit_button: "Edit",
      host_button: "Host",
      delete_confirm_title: "Delete this quiz?",
      delete_confirm_body: '"{title}" and every score in it will be gone for good.',
    },
    builder: {
      prompt_label: "Question",
      section_title_label: "Round title",
      ...
      x_low_placeholder: "Low end (left)",
      x_high_placeholder: "High end (right)",
      y_low_placeholder: "Low end (bottom)",
      y_high_placeholder: "High end (top)",
      axis_default_low: "Low",
      axis_default_high: "High",
      heatmap_target_hint: "Tap the pad to set the correct spot",
      time_limit_label: "Time limit (seconds)",
      untimed_placeholder: "No limit",
      points_label: "Points",
      move_up: "Move up",
      move_down: "Move down",
      save: "Save",
      saved: "Saved",
      empty_state: "Add a slide to get started.",
      go_live: "Go live",
      go_live_confirm_title: "Start this quiz?",
      go_live_confirm_body:
        "The slides lock while it's live. End or reset the session to edit them again.",
      go_live_confirm_action: "Go live",
      open_host: "Open host console",
      locked_banner: "This quiz is live — end or reset the session to edit its slides.",
      delete_slide_confirm_title: "Delete this slide?",
    },
    host: {
      draft_body: "Ready when you are — starting opens the room for guests to join.",
      start_button: "Start",
      join_code_label: "Join code",
      qr_alt: "QR code to join the quiz",
      lobby_hint: "Guests scan the code or open the link to join.",
      no_players_yet: "Waiting for the first guest to join…",
      begin_button: "Start round",
      answered_count: "{answered} of {total} answered",
      reveal_button: "Reveal",
      next_button: "Next",
      end_button: "End quiz",
      final_leaderboard_title: "Final leaderboard",
      reset_button: "Reset for another round",
      reset_confirm_title: "Reset this quiz?",
      reset_confirm_body:
        "Every player and score is cleared and a new join code is issued. The slides stay.",
      reset_confirm_action: "Reset",
      round_progress: "Round {current} of {total}",
    },
    play: {
      join_kicker: "You're invited to play",
      hosted_by: "Hosted by {name}",
      name_label: "Your name",
      name_placeholder: "What should we call you?",
      avatar_label: "Pick a character",
      join_button: "Join",
      waiting_title: "You're in, {name}!",
      waiting_body: "Waiting for the host to start…",
      players_joined: "{count} joined so far",
      answer_locked_in: "Answer locked in — waiting for everyone else…",
      correct_banner: "Correct! +{points}",
      incorrect_banner: "Not quite",
      correct_value: "The answer was {value}",
      no_correct_answer: "No correct answer for this one",
      your_rank_score: "You're #{rank} with {score} points",
      submit_answer: "Submit",
      ended_title: "That's the quiz!",
      your_rank: "You finished #{rank}",
      not_found_title: "Quiz not found",
      not_found_body:
        "This code doesn't match a quiz. Double check the link or ask your host for a new one.",
    },
  },
  markets: {
    ...
    status_live: "Live — guests can join and bet",
    status_ended: "Paused — no new joins or bets",
    start_button: "Go live",
    end_button: "Pause",
    resume_button: "Resume",
    join_code_label: "Join code",
    share_link_label: "Guest link",
    copy_link: "Copy link",
    copied: "Copied!",
    qr_alt: "QR code to join the predictions board",
    add_question_title: "Add a question",
    prompt_label: "Question",
    prompt_placeholder: "Will the groom cry during the vows?",
    closes_label: "Betting closes",
    add_button: "Add question",
    empty_title: "No questions yet",
    empty_body: "Add your first one below.",
    question_status_open: "Open",
    question_status_closed: "Closed — awaiting result",
    question_status_resolved: "Resolved",
    question_status_voided: "Voided — refunded",
    pool_label: "{yes} pts YES · {no} pts NO",
    probability_label: "{pct}% chance",
    resolve_yes: "Yes won",
    resolve_no: "No won",
    void_button: "Void",
    void_confirm_title: "Void this question?",
    void_confirm_body: "Every stake on it is refunded in full. This can't be undone.",
    delete_button: "Delete",
    delete_confirm_title: "Delete this question?",
    delete_confirm_body: "Nobody has bet on it yet, so nothing needs refunding.",
    leaderboard_title: "Leaderboard",
    leaderboard_empty: "No guests have joined yet.",
    balance_pts: "{balance} pts",
    outcome_label: "Result: {outcome}",
    save_error: "Couldn't save. Try again.",
    stat_open_questions: "Open questions",
    stat_total_staked: "Points staked",
    stat_guests: "Guests",
  ...
  markets_play: {
    ...
    avatar_label: "Pick a character",
    join_button: "Join",
    balance_label: "Your points",
    bet_yes: "Yes",
    bet_no: "No",
    stake_label: "Points to bet",
    estimated_return_label: "Estimated payout",
    estimated_return_hint:
      "If nobody else bets before close. The real payout is only fixed when the question resolves.",
    profit_label: "Profit if you win",
    place_bet: "Place bet",
    your_position: "You bet {stake} pts on {side}",
    position_value: "Now worth ~{value} pts",
    closes_in: "Closes {when}",
    closed_note: "Betting closed — waiting on the result",
    resolved_note: "Result: {outcome}",
    voided_note: "Voided — your stake was refunded",
    you_won: "You won {payout} pts",
    you_lost: "You lost this one",
    leaderboard_title: "Leaderboard",
    not_live_note: "This board isn't open yet — check back soon.",
    ended_note: "This board has been paused by the couple.",
    not_found_title: "Board not found",
    not_found_body: "This code doesn't match a predictions board. Double check the link.",
    insufficient_balance: "Not enough points",
    side_locked: "You already bet the other side on this one",
  },
  schedule: {
    title: "Run of show",
  ...
  guests: {
    title: "Guest list",
    photo_upload_guests_link: "Guests who joined the photo upload",
    add: "Add guest",
    ...
    meals_menu_add_option: "Add your own option",
    meals_menu_remove_option: "Remove option",
    meals_menu_custom_placeholder: "Your option, e.g. Halal",
    meal_custom_unnamed: "Unnamed option",
    ...
    household_guest_message: "Message from this party",
    ...
    table_household_rename_hint: "Renames the household for everyone in it",
    ...
    duplicate_name_warning: "You already have a guest with this name.",
    duplicate_name_warning_household: "You already have a guest with this name, in {household}.",
  },
  budget: {
    title: "Budget",
    ...
    payment_pdf_attached: "PDF attached.",
    payment_pdf_failed: "Couldn't upload the PDF.",
    payment_remaining: "Remaining",
    payment_settled: "Fully paid",
    payment_overpaid: "Overpaid by {amount}",
    paid_overpaid_by: "Overpaid by {amount} — check the actual cost or the payments",
    ...
    docs_hint: "PDF or image (JPG, PNG, WebP), up to 6 MB.",
    ...
    cost_planning_saved: "Saved",
    cost_planning_save_error: "Couldn't save",
    ...
    payments_group_overdue: "Overdue",
    payments_group_7: "Within 7 days",
    payments_group_later: "Later",
    payments_group_undated: "No date yet",
    payments_group_paid: "Paid",
    payments_overdue_by: "{n} days late",
    payments_mark_paid_aria: "Mark the {name} payment as paid",
    payments_marked_paid: "Payment recorded.",
    lines_title: "Budget lines",
    lines_sub: "Edit each line, totals above and bars update live.",
    lines_all_zero: "Nothing has an amount yet. Use the sliders above to plan each category.",
    ...
    supplier_managed_hint: "Set on the supplier's card",
    ...
    subcategory_quick_add: "Quick add:",
    subcat: {
      photo_video: { photo: "Photo", video: "Video" },
      music_dj: { dj: "DJ", live_music: "Live music" },
      decor_floral: { decor: "Decor", flowers: "Flowers" },
      attire: { bride: "Bride", groom: "Groom" },
      hair_makeup: { hair: "Hair", makeup: "Make-up" },
    },
  },
  diy: {
  ...
  income: {
    ...
    sub: "Cash gifts and contributions, at the end you'll see how much of the spend came back. You keep the entries on the wishlist's “After the wedding” tab.",
    received: "Total received",
    spent: "Spent",
    net_cost: "Net cost of the day",
    surplus: "Surplus",
    recovered_pct: "{pct}% recovered",
    count_money: "{n} cash gifts",
    count_other: "{n} other gifts",
    empty: "No gifts recorded yet",
    manage_link: "Manage gifts",
    open_ledger_aria: "Open received gifts on the wishlist",
  ...
  logistics: {
    ...
    offer_on_rsvp: "Offer this on the RSVP",
    offer_on_rsvp_help:
      'Guests choose between the places you offer instead of just ticking "I need a room". They see the name, address, price and booking link. Your contact and notes stay private.',
  ...
  suppliers: {
    ...
    verified_vendor_incomplete: "Verified vendor · still finishing their profile",
    ...
    diy_modal_price_label: "Expected cost",
    ...
    twin: {
      title: "Already on Weddly",
      blocking_title: "This vendor is already on Weddly",
      body: "Pick the listed one and you get its photos, address and reviews too.",
      use: "Use this one",
      different: "This is a different vendor",
      adopted_toast: "{name} added",
    },
    search_label: "Search",
    ...
    empty_picked_hidden: "Your picks are outside these filters.",
    empty_picked_show_all: "Show my picks",
    empty_saved_hidden: "Your saved vendors are outside these filters.",
    empty_saved_show_all: "Show saved",
    empty_picked_none: "You have not picked any vendors yet.",
    empty_saved_none: "Nothing saved yet.",
    out_of_country_heading: "On Weddly, outside {country}",
    out_of_country_note: "Registered vendors who work in another country.",
    out_of_country_show_all: "Show {n} more, all countries",
    ...
    group: {
      ...
      paper_design: "Paper goods & design",
      transport: "Transport",
    },
    cat: {
    ...
    compare: {
      ...
      capacity_not_relevant: "Not relevant for this category",
  ...
  admin: {
    ...
    vendors: {
      ...
      incomplete_tooltip: "Missing: {sections}",
      missing_cover: "cover photo",
      missing_gallery: "gallery",
      missing_description: "bio",
      missing_contact: "contact",
      missing_pricing: "price range",
      missing_capacity: "capacity",
      ...
      joined_tooltip: "Joined",
      last_active_tooltip: "Last signed in: {date}",
      never_signed_in: "Never signed in",
      never_signed_in_tooltip:
        "The account is live and the listing is public, but the vendor has never signed in.",
      listing_edited: "Last edited: {date}",
      inquiries_tooltip: "Inquiries from couples",
      ...
      founding_tooltip: "Founding member — one of the first {cap} vendors.",
      ...
      field_name_help: "The brand name shown on the listing.",
      field_category: "Category",
      field_company: "Company name",
      field_company_help: "Legal company name — shown small, under the brand name.",
      field_email: "Contact email",
      field_phone: "Contact phone",
      field_vat: "VAT number",
      suspend_confirm_title: "Suspend this vendor?",
      reactivate_confirm_title: "Reactivate this vendor?",
    ...
    planners: {
      ...
      invite_batch_cta: "Invite from a list",
      invite_batch_title: "Invite suggested planners",
      invite_batch_intro:
        "Paste the list: name, email, phone, in any order. Every row gets a dormant account with two years of access, plus one email that takes it over in a click. Preview first to check what the parser read.",
      invite_batch_placeholder:
        "Anna Kovacs (Anna Weddings)\nanna@examplestudio.com\n+36 30 123 4567",
      invite_batch_locale: "Email language",
      invite_batch_locale_auto: "Automatic (from phone number and domain)",
      invite_batch_preview: "Preview",
      invite_batch_send: "Send invites",
      invite_batch_parsed: "{count} rows",
      invite_batch_empty: "No email address came out of that text.",
      invite_batch_col_name: "Name",
      invite_batch_col_email: "Email",
      invite_batch_col_phone: "Phone",
      invite_batch_col_status: "Status",
      invite_batch_status_ready: "Ready",
      invite_batch_status_sent: "Sent",
      invite_batch_status_existing: "Already has an account",
      invite_batch_status_opted_out: "Unsubscribed",
      invite_batch_status_failed: "Failed",
      invite_batch_done: "{sent} invites sent.",
      ...
      reactivate_confirm_title: "Reactivate this planner?",
    ...
    waitlist_sub: "Submissions from the /suppliers form.",
    ...
    married_section: "Married",
    married_count_one: "{n} married",
    married_count_other: "{n} married",
    married_empty: "No married couples yet.",
    ...
    table_workspace_total_time: "Total time",
    total_time_tooltip: "Cumulative time spent in the app (all-time)",
    total_time_none: "-",
    total_time_under_minute: "<1m",
    total_time_minutes: "{n}m",
    total_time_hm: "{h}h {m}m",
    ...
    flag_tpl_vendor_abuse_label: "/suppliers form abuse",
    ...
    status_pending: "Awaiting admin review",
    status_awaiting_review: "Ownership confirmed",
    filter_status_label: "Filter",
    filter_status_all: "All",
    filter_status_pending: "Awaiting review",
    filter_status_awaiting_review: "Ownership confirmed",
    filter_status_active: "Approved",
    filter_status_hidden: "Hidden",
    approve: "Approve",
    approve_success: "Approved, supplier is now in the public directory.",
    approve_hint: "Publishes the listing and emails the supplier that they've been added.",
    send_verify: "Send verify email",
    send_verify_hint:
      "Optional — ask the supplier to confirm ownership before you approve. Not required.",
    ...
    suppliers_card_submitter_visitor: "Visitor",
    suppliers_card_submitter_no_account: "No account",
    ...
    suppliers_edit: "Edit listing",
    suppliers_edit_cancel: "Cancel",
    suppliers_edit_save: "Save listing",
    suppliers_edit_saving: "Saving…",
    suppliers_edit_success: "Listing updated.",
    suppliers_edit_no_changes: "Nothing changed.",
    suppliers_edit_section_place: "Place",
    suppliers_edit_field_lat: "Latitude",
    suppliers_edit_field_lng: "Longitude",
    suppliers_edit_coords_help: "Both are needed for the map. Decimal degrees, e.g. 43.28994.",
    suppliers_card_field_capacity: "Capacity",
    suppliers_edit_field_capacity_min: "Capacity from",
    suppliers_edit_field_capacity_max: "Capacity to",
    suppliers_edit_field_venue_style: "Venue style",
    suppliers_edit_field_venue_style_none: "Unclassified",
    suppliers_edit_field_languages: "Spoken languages",
    suppliers_edit_field_price_band_none: "Unpriced",
    suppliers_edit_city_help: 'Outside Hungary add the country code: "Siena, IT".',
    suppliers_photos_section: "Photos",
    suppliers_photos_empty: "No photos yet. The card shows a category icon.",
    suppliers_photos_hero: "Card image",
    suppliers_photos_gallery: "Gallery",
    suppliers_photos_upload: "Upload photo",
    suppliers_photos_uploading: "Uploading…",
    suppliers_photos_upload_invalid_type: "Choose a JPEG, PNG, or WebP image.",
    suppliers_photos_upload_too_large: "The image must be 4 MB or smaller.",
    suppliers_photos_add_placeholder: "https://…/photo.jpg",
    suppliers_photos_add: "Add photo",
    suppliers_photos_adding: "Downloading…",
    suppliers_photos_add_help:
      "Upload a JPEG, PNG, or WebP image (max 4 MB), or paste an image link. The first one becomes the card image.",
    suppliers_photos_added: "Photo added.",
    suppliers_photos_removed: "Photo removed.",
    suppliers_photos_remove_aria: "Remove photo",
    suppliers_photos_make_hero: "Use as card image",
    ...
    directory_gap_flagged_email: "Email on hold",
    directory_email_flag: "On hold",
    directory_email_flag_generic: "Shared or group address, does not reach this business",
    directory_email_flag_unverified: "May not belong to this business, needs checking",
    ...
    directory_submitter_visitor: "Visitor recommendation",
    ...
    nav_feedback: "Feedback",
    nav_content_notices: "Content notices",
    ...
    feedback_reply_label: "Reply to submitter",
    feedback_reply_placeholder: "Write your reply to the submitter…",
    feedback_reply_send: "Send reply",
    feedback_reply_sent: "Reply sent",
    feedback_reply_channel_email: "Email",
    feedback_reply_channel_notification: "In-app notification",
    feedback_reply_channel_both: "Both",
    feedback_reply_no_recipient:
      "This submission has no email or account on file, so no reply can be sent.",
    feedback_reply_no_email_hint: "No email address on file for this submitter.",
    feedback_reply_no_workspace_hint:
      "Submitter has no Weddly workspace for an in-app notification.",
    feedback_reply_history_label: "Sent replies",
    feedback_reply_via_email: "via email",
    feedback_reply_via_notification: "in-app",
    feedback_reply_via_both: "via email + in-app",
    ...
    analytics_nav_planners: "Planners",
    analytics_nav_campaigns: "Campaigns",
    analytics_nav_users: "Users",
    ...
    analytics_section_planners: "Planners",
    analytics_planners_subtitle: "From the waitlist to a paid subscription.",
    analytics_planners_empty: "No planner accounts yet.",
    analytics_planners_total: "Planners",
    analytics_planners_active: "Active",
    analytics_planners_pending: "Awaiting registration",
    analytics_planners_suspended: "Suspended",
    analytics_planners_awaiting: "{n} accepted, no account",
    analytics_planners_with_client: "{n} working with a client",
    analytics_planners_funnel_title: "Funnel",
    analytics_planners_step_applied: "Applied",
    analytics_planners_step_accepted: "Accepted",
    analytics_planners_step_account: "Got an account",
    analytics_planners_step_activated: "Activated",
    analytics_planners_step_with_client: "Has a client",
    analytics_planners_step_paying: "Paying",
    analytics_planners_capacity_title: "Capacity",
    analytics_planners_capacity_sub: "{avg} clients on average",
    analytics_planners_tier_starter: "Starter",
    analytics_planners_tier_pro: "Pro",
    analytics_planners_tier_premium: "Premium",
    analytics_planners_tier_sub: "{n} planners · {cap} client cap",
    analytics_planners_billing_title: "Subscription",
    analytics_planners_free_window: "In free window",
    analytics_planners_paying: "Paying",
    analytics_planners_conversion: "Conversion",
    analytics_planners_time_to_paid:
      "About {days} days to paid (approximate, from the subscription's last update).",
    analytics_planners_sub_trialing: "Trial",
    analytics_planners_sub_founding: "Founding",
    analytics_planners_sub_active: "Active",
    analytics_planners_sub_past_due: "Past due",
    analytics_planners_sub_canceled: "Canceled",
    analytics_planners_sub_none: "No subscription",
    analytics_planners_signups_title: "Daily signups",
    analytics_planners_signups_sub: "{n} in the last 30 days",
    analytics_section_campaigns: "Campaigns",
    analytics_campaigns_subtitle: "All four campaign families in one place.",
    analytics_campaigns_empty: "No campaign mail has gone out yet.",
    analytics_campaigns_sent: "Sent",
    analytics_campaigns_open_rate: "Open rate",
    analytics_campaigns_click_rate: "Click rate",
    analytics_campaigns_conv_rate: "Conversion",
    analytics_campaigns_converted: "Converted",
    analytics_campaigns_utm: "UTM signups",
    analytics_campaigns_optout: "Opted out",
    analytics_campaigns_failed: "{n} failed",
    analytics_campaigns_campaign_count: "{n} campaigns",
    analytics_campaigns_daily_title: "Daily sends and conversions",
    analytics_campaigns_daily_sub: "last {days} days",
    analytics_campaigns_family_title: "Channels side by side",
    analytics_campaigns_family_sub: "conversion means something different per family",
    analytics_campaigns_col_family: "Family",
    analytics_campaigns_col_campaign: "Campaign",
    analytics_campaigns_table_title: "Campaigns",
    analytics_campaigns_table_sub: "most recently launched first",
    analytics_section_users: "Users and workspaces",
    analytics_users_empty: "No data yet.",
    analytics_users_total: "Users",
    analytics_users_paired: "Paired workspaces",
    analytics_users_paired_sub: "{pct}% of all",
    analytics_users_solo: "Solo",
    analytics_users_time_to_pair: "median {days} days to pair",
    analytics_users_no_workspace: "No workspace",
    analytics_users_recency_title: "Last seen",
    analytics_users_recency_sub: "by last sign-in",
    analytics_users_recency_week: "This week",
    analytics_users_recency_month: "This month",
    analytics_users_recency_dormant30: "30+ days ago",
    analytics_users_recency_dormant90: "90+ days ago",
    analytics_users_recency_never: "Never",
    analytics_users_cohorts_title: "Cohorts",
    analytics_users_cohorts_sub: "how many stayed active",
    analytics_users_cohorts_note: "admin: {admins} · test: {test} · demo: {demo}",
    analytics_users_col_month: "Month",
    analytics_users_col_workspaces: "Workspaces",
    analytics_users_col_active: "Active 30d",
    analytics_users_col_share: "Share",
    ...
    analytics_money_avg_planned_per_head: "Avg planned / guest",
    analytics_money_avg_actual_per_head: "Avg actual / guest",
    analytics_money_per_head_denom: "Couples with a target headcount",
    ...
    analytics_money_col_avg_planned_per_head: "Avg planned / guest",
    analytics_money_col_avg_actual_per_head: "Avg actual / guest",
    ...
    analytics_activity_signups_kind_couples: "Couples",
    analytics_activity_signups_kind_planners: "Planners",
    analytics_activity_signups_kind_vendors: "Vendors",
    analytics_activity_signups_kind_sub: "{n} in 14 days",
    ...
    plan_title: "Plan",
    plan_subtitle:
      "Campaigns compose themselves; all you do is run them. Repeat and interval are per card.",
    plan_what_vendor_claim: "Invites unclaimed directory listings to take over their profile.",
    plan_what_vendor_review:
      "Reminds claimed vendors to ask past clients for a review, with their own link.",
    plan_what_onboarding_name: "Onboarding re-engagement",
    plan_what_onboarding:
      "Wins back accounts that registered and verified but never started planning.",
    plan_repeat: "Repeat",
    plan_interval: "Interval (days)",
    plan_auto_start: "Auto start",
    plan_reach: "{n} addresses waiting",
    plan_cooling: "{n} cooling down ({days} days)",
    plan_next: "Next: {date}",
    plan_no_repeat: "Does not repeat",
    plan_prepared: "{slug} · would reach {n}",
    plan_prepare: "Prepare",
    plan_run: "Run",
    plan_open_console: "Console",
    plan_empty: "No plan yet.",
    plan_prepared_toast: "Ready, {n} addresses. Yours to run.",
    plan_started_toast: "Running, sends are paced from here.",
    plan_skip_too_few: "Too few addresses ({n}), waiting for the next round.",
    plan_skip_in_flight: "The previous campaign hasn't finished yet.",
    campaign_title: "Claim-invite campaign",
    campaign_subtitle:
      "Invites unclaimed directory listings to take over their own profile. Cold mail cannot be unsent, so read the target list before you start.",
    campaign_new: "New campaign",
    campaign_slug: "Handle",
    campaign_country: "Country",
    campaign_country_all: "All",
    campaign_daily_cap: "Daily cap",
    campaign_create: "Create",
    campaign_created: "Campaign created, paused.",
    campaign_empty: "No campaigns yet.",
    campaign_status_paused: "Paused",
    campaign_status_running: "Running",
    campaign_status_done: "Finished",
    campaign_start: "Start",
    campaign_pause: "Pause",
    campaign_send_batch: "Send {n}",
    campaign_run_reminders: "Run reminders",
    campaign_reminders_sent: "{n} reminders sent.",
    campaign_batch_sent: "{n} invites sent.",
    campaign_stat_remaining: "Remaining",
    campaign_stat_sent: "Sent",
    campaign_stat_opened: "Opened",
    campaign_stat_clicked: "Clicked",
    campaign_stat_reminded: "Reminded",
    campaign_stat_claimed: "Claimed",
    campaign_stat_failed: "Failed",
    campaign_stat_today: "{n}/{cap} in the last 24h",
    campaign_offer: "The invite promises {months} months free, {left} of {cap} spots left.",
    campaign_offer_none: "Both free cohorts are full, so the invite makes no free-window promise.",
    campaign_plan: "{n} addresses · {cap} a day · about {days} days to send.",
    campaign_plan_empty: "Nobody to write to in this segment.",
    campaign_preview_invite: "Invite",
    campaign_preview_reminder: "Reminder",
    campaign_targets: "Who this writes to next",
    campaign_targets_hint:
      "Unclaimed, live listings with a contact address, minus anyone suppressed, already written to, or already holding a Weddly account.",
    campaign_targets_empty: "Nobody left to write to.",
    campaign_sends: "Sent",
    campaign_send_sent: "Sent",
    campaign_send_clicked: "Clicked",
    campaign_send_reminded: "Reminded",
    campaign_send_claimed: "Claimed",
    campaign_send_failed: "Failed",
    campaign_optout: "Suppress an address",
    campaign_optout_hint:
      "For the “take me off your list” replies that land in the inbox instead of going through the footer link. Permanent, across every campaign.",
    campaign_optout_email: "Email address",
    campaign_optout_add: "Suppress",
    campaign_optout_added: "Address suppressed.",
    campaign_start_confirm_title: "Start sending?",
    campaign_start_confirm_body:
      "{n} addresses are queued. They go out at up to {cap} a day and cannot be recalled.",
    campaign_start_confirm_cta: "Start",
    campaign_batch_confirm_title: "Send a batch now?",
    campaign_batch_confirm_body: "Up to {n} invites go out immediately.",
    ...
    onbcamp_title: "Onboarding re-engagement",
    onbcamp_subtitle:
      "Nudge registered couples who verified their email but never set up a workspace.",
    onbcamp_stat_total: "Targeted",
    onbcamp_stat_queued: "Queued",
    onbcamp_stat_converted: "Onboarded",
    onbcamp_stat_reminded: "Reminded",
    onbcamp_stat_lang: "HU / EN",
    onbcamp_sync_heading: "Audience",
    onbcamp_sync_hint: "Pulls the current workspace-less couples into the queue.",
    onbcamp_sync_cta: "Sync audience",
    onbcamp_sync_result: "Added {added} · already queued {existing} · opted out {optout}.",
    onbcamp_eligible: "{n} eligible to sync",
    onbcamp_contacts: "Recipients",
    onbcamp_contacts_hint: "Live: onboarded rows count as converted.",
    onbcamp_contacts_empty: "No recipients yet. Sync the audience to queue them.",
    onbcamp_contacts_more: "and {n} more",
    onbcamp_send_queued: "Queued",
    onbcamp_send_skipped: "Skipped",
    onbcamp_send_converted: "Onboarded",
    onbcamp_reminded_badge: "Reminded",
  ...
  rsvp: {
    ...
    checkin_member_email_help: "We'll use this to send you wedding updates.",
    ...
    dietary_other_placeholder: "Something else? Write it here",
    dietary_privacy_notice:
      "Optional health information. Only the hosts and their authorised planner use it for catering and event safety.",
    dietary_privacy_link: "How guest data is handled",
    dietary_consent_label:
      "I explicitly consent to Weddly storing the allergy/dietary health information entered above for catering and event safety. I can withdraw this consent by clearing these fields and resubmitting, or by asking the hosts/Weddly to erase it.",
    dietary_consent_required: "Please consent before submitting allergy or dietary health data.",
    accommodation_section_title: "Where would you like to stay?",
    accommodation_none: "No accommodation needed",
    guest_message_label: "Message to the couple",
    guest_message_placeholder: "Anything you would like them to know",
    guest_message_help: "Optional. Only the couple sees this.",
  ...
  profile: {
    ...
    workspaces_create_date_label: "Date",
    ...
    pause_reason_note_label: "Anything else you'd like to share",
  ...
  privacy: {
    ...
    data_categories_analytics:
      "Analytics and attribution: at sign-up we record a country code derived from your IP, campaign parameters and device class under legitimate interest. On public pages, optional audience measurement (Plausible, Google Analytics/Tag Manager and Microsoft Clarity when configured) starts only after you choose the statistics category in our consent manager. You can reject it or withdraw that choice at any time from Cookie settings.",
    ...
    legal_bases_consent:
      "Consent (Art. 6(1)(a)), for optional analytics cookies and any optional marketing communication you actively choose. The Privacy Policy itself is a notice, not a request for consent; registration records that the current notice and contractual terms were presented. You may withdraw a consent at any time without affecting earlier lawful processing.",
    ...
    guest_data_body:
      "If you arrived as a wedding guest, your name and contact details came from the inviting couple, who controls that guest list; Weddly hosts it on their behalf. Dietary and allergy details can reveal health information. Supplying them is optional and requires your explicit consent under GDPR Article 9(2)(a); they are shown only to the couple and authorised planner for catering and event safety, and are never included in cross-customer analytics. You can withdraw consent by clearing those fields and resubmitting, or ask the couple to correct or erase them; you may also email hello@tryweddly.com and we will relay and track the request. Do not submit another person's health information unless you are authorised to consent for them.",
    ...
    directory_listings_source:
      "We use public business websites, public registers and map data, a business's own submission, or a user recommendation. An unclaimed entry publishes factual business information only. It has no photograph unless Weddly has recorded a licence or the business has claimed the profile and uploaded or expressly authorised the image. We do not treat an og:image tag or public availability by itself as a copyright licence.",
    ...
    directory_listings_ip:
      "Names and trademarks are used only to identify the referenced business in accordance with honest commercial practice. Photographs remain protected works: Weddly publishes them only after the rights holder or an authorised vendor supplies them, or where a recorded licence permits the use. Rights holders can request immediate removal at hello@tryweddly.com.",
    ...
    retention_body:
      "Couple workspaces are kept while active. A couple can pause from Profile: we keep the workspace for a 30-day grace period, then delete it, and the pause can be cancelled during that period. Planners can export or delete from Planner Settings. Vendors can download a JSON export; until self-service deletion exists, vendor termination and erasure requests are handled at hello@tryweddly.com and confirmed with their scope and timing. Records required for tax, accounting, disputes or security are retained only for the applicable legal period, and backup copies age out under the documented backup retention schedule.",
    ...
    rights_access:
      "Access (Art. 15), couples can export from Profile, planners from Planner Settings, and vendors from their Data settings. Email hello@tryweddly.com if the relevant export is unavailable.",
    ...
    rights_deletion:
      "Erasure (Art. 17), couples use pause-and-delete in Profile and planners use Planner Settings. Vendor requests currently go to hello@tryweddly.com. We confirm the scope and timing, and retain only records that an applicable legal obligation or unresolved claim requires.",
    rights_portability:
    ...
    security_body:
      "We never see your password: it is hashed with Argon2id before storage. Browser sessions use random, signed opaque tokens in Secure, HttpOnly, SameSite cookies; they can be revoked server-side and are verified with HMAC-SHA256. All network traffic is TLS-encrypted. The database is SQLite on a persistent volume. Significant operations are recorded in an application audit log; legally required security records may be retained after account deletion with access restricted to authorised operators.",
    ...
    transfers_body:
      "Some enabled providers may process data outside the EEA. Before enabling a provider, Weddly records its role, processing region and applicable transfer mechanism (such as an adequacy decision or Standard Contractual Clauses) in the vendor register. Contact us for the current safeguards or a copy where available.",
    subprocessors_title: "Subprocessors (GDPR Art. 28)",
    subprocessors_intro:
      "The following providers may receive data when their corresponding feature is enabled. Some, including payment and identity providers, may act as independent controllers for their own regulated purposes. The production vendor register—not this label alone—records role, region, contract and transfer evidence.",
    subprocessors_railway:
      "Railway Corp. (USA), application hosting and storage of the SQLite database. The applicable processing region, contract and transfer safeguard must be verified in Weddly's production vendor register before launch.",
    subprocessors_resend:
      "Resend Inc. (USA), delivery of transactional email (registration, password reset, partner invite, RSVP receipts). Contract and transfer safeguards must be verified in the production vendor register before launch.",
    ...
    subprocessors_sentry:
      "Sentry (USA), optional application error reporting. When configured, Weddly sends scrubbed error telemetry with default personal-data collection disabled; the production vendor register records its region and transfer safeguards.",
    ...
    cookies_session:
      "weddly_session, a signed random session id in a Secure, HttpOnly, SameSite cookie. Browser scripts cannot read it; it is revoked and cleared when you sign out.",
    ...
    third_parties_body:
      "The provider inventory is above. We do not sell personal data or share it with data brokers. Optional analytics receives public-page usage only after statistics consent; payment, identity, storage, email, translation and AI providers receive only the fields needed for the feature you invoke.",
    ...
    automated_decisions_body:
      "Weddly does not take solely automated decisions that produce legal or similarly significant effects. Ranking and planning helpers are suggestions. If a vendor asks the optional AI Concierge to draft a reply, Weddly sends the inquiry text and limited booking context to Anthropic; the vendor must review and choose whether to send it, and should not include sensitive information.",
    ...
    proc_account_retention:
      "Retention: while the account is active. Couple accounts use a 30-day pause-to-delete grace period; planners can delete in settings; vendor erasure is currently handled by email. Legally required accounting, dispute and security records and time-limited encrypted backups follow their separate retention periods.",
    ...
    proc_guest_camera_title: "Wedding Film — guest camera",
    proc_guest_camera_data:
      "Data processed: the name and email address a guest types in before shooting, the device identifier, the photos they submit, and, only if the checkbox is ticked, a record that marketing consent was given (with the IP address and browser used at that moment).",
    proc_guest_camera_purpose:
      "Purpose: telling guests with the same first name apart so their photos and shot count are attributed correctly, letting the couple (and, later, us) send a guest their own photos, and, only with separate explicit consent, sending occasional Weddly news.",
    proc_guest_camera_basis:
      "Legal basis: Art. 6(1)(b) GDPR, performance of the guest-camera service the guest is actively using, for the name, email and photos; Art. 6(1)(a), freely given and withdrawable consent, for the optional marketing checkbox alone.",
    proc_guest_camera_retention:
      "Retention: for as long as the wedding film exists, or until the guest asks hello@tryweddly.com to erase their entry. Marketing consent lasts until withdrawn the same way.",
  ...
  terms: {
    ...
    seo_description:
      "The short open-beta terms of service for Weddly: free to use, no SLA, governed by Hungarian law.",
    ...
    dsa_body:
      "Regulation (EU) 2022/2065 (DSA) requires every hosting provider to operate an easy-to-use notice mechanism for illegal content. If you believe content published on Weddly is unlawful, use the permanent Report illegal content form linked from every page. It records the exact URL, grounds, your contact details and good-faith declaration, emails a case reference, and provides status, a reasoned outcome and an appeal path. You may also write to hello@tryweddly.com for assistance.",
    dsa_contact:
    ...
    law_body:
      "These terms are governed by Hungarian law together with applicable EU data-protection and consumer-protection rules, notably the GDPR and DSA. We try to resolve disputes by email first. Consumers retain every mandatory forum and remedy available in their country of habitual residence.",
    contact_title: "Questions?",
    contact_body: "Email hello@tryweddly.com or andor.csikasz@gmail.com.",
    en_section_label: "English",
  },
  subscription_terms: {
    seo_title: "Vendor subscription terms (ÁSZF) · Weddly",
    seo_description:
    ...
    unclaimed_body:
      "The Weddly directory also contains businesses that have not registered and have not claimed their profile. An entry creates no contract, payment obligation, partnership or endorsement. It contains factual public business data only and no photograph unless Weddly has a documented licence. The business may request correction, free take-over, contact suppression or object to the listing at hello@tryweddly.com. We respond without undue delay and within 30 days; contact details, descriptions and images are removed on request. The Privacy Policy explains the Art. 14 GDPR procedure.",
    ratings_title: "Reviews and the Vendor's remedies",
    ratings_body:
      'Couples may write reviews on a directory entry even before the Vendor has claimed the profile. The Operator does not commission or pay for reviews and does not re-rank them by star rating; the "Verified" mark means only that the reviewer also recorded the supplier in their own planning, not that the Operator verified performance. A public Vendor-reply feature is not currently available. The Vendor may report a review at hello@tryweddly.com; reports are handled under the Content moderation section and receive a reasoned outcome. The Operator does not remove lawful reviews merely because they are unfavourable, and a Vendor subscription does not influence review display.',
    ...
    sla_body:
      "During the free open beta, the Operator provides no contractual uptime SLA or service credits. Planned maintenance and material incidents are communicated where reasonably possible. Any paid launch will publish the applicable service level and remedies before a Vendor incurs a fee.",
    ranking_title: "Ranking and featured placements",
    ranking_body:
      "The default public directory order first applies the couple's chosen category and location filters. Within that result, the principal ranking signals are whether the profile has a photo, whether it is claimed, profile completeness, and then the business name as a stable tie-breaker. In the signed-in planning view, the couple's own saved vendors and community votes may additionally move a result up. Review rating, response time and subscription plan do not currently change organic ranking. Any paid placement must be visibly labelled 'Featured' and distinguished from organic results. A material change to these main parameters is announced through the ÁSZF amendment procedure (EU 2019/1150 P2B Regulation art. 5).",
    ...
    data_access_body:
      "While the account is active, the Vendor can edit and export its profile and download its JSON account data, including received enquiries and available statistics. It cannot access other Vendors' data, internal ranking weights, or the Operator's internal data. Because the service does not currently provide a post-termination read-only account, the Vendor should download its export before requesting termination; the Off-boarding section explains the support-assisted process.",
    ...
    offboarding_body:
      "The Vendor can download its JSON data export from the account at any time. Until self-service deletion is implemented, termination and erasure requests are handled at hello@tryweddly.com: Weddly removes the public profile, confirms the planned deletion scope and timing, and retains only records required by tax, accounting, dispute or security law. We do not promise an automated read-only or former-vendor archive that the service does not currently provide.",
    ...
    odr_title: "Alternative dispute resolution",
    odr_body:
      "The EU Online Dispute Resolution platform was discontinued on 20 July 2025. Consumer Vendors may use the competent Hungarian conciliation body; current authority and contact details are provided in the Imprint and in our response to a complaint. Mandatory consumer remedies remain unaffected.",
    contact_title: "Contact",
    contact_body:
      "All queries about the ÁSZF and the service Weddly provides to vendors should be addressed to hello@tryweddly.com. Illegal-content notices can also be submitted through the permanent Report illegal content form. The Operator's §4 Ektv. identification details are available on the Imprint page.",
    en_section_label: "English",
  },
  ...
  session: {
    ...
    admin_reauth_title: "Confirm it's you",
    admin_reauth_body:
  ...
  tour: {
    ...
    design_p1_title: "Pick a look",
    design_p1_body:
      "Start from a finished look shown on a card with your own names. One tap sets your palette, fonts and date style. Fine tune anything after from the list below.",
    design_p2_title: "One look, two surfaces",
    design_p2_body:
      "Switch between your guest site and your printed cards. They share the same look, so a change on one shows up on both.",
    design_p3_title: "Everything inherits it",
    design_p3_body:
  ...
  tools: {
    ...
    guest_list_template: {
      ...
      try_h2: "Try it — add a guest or two",
      try_caption:
        "Type a couple of real names below and watch the sheet fill in. Download exactly what you typed, no signup needed.",
      try_first_name_placeholder: "First name",
      try_last_name_placeholder: "Last name",
      try_household_placeholder: "Household",
      try_diet_placeholder: "Diet (optional)",
      try_plus_one_placeholder: "Plus-one (optional)",
      try_status_pending: "Pending",
      try_status_yes: "Yes",
      try_status_no: "No",
      try_add_btn: "Add guest",
      try_remove_label: "Remove",
      try_empty: "No guests yet, add the first one below.",
      try_count_label: "Guests in your list",
      try_download_btn: "Download your list as CSV",
      try_download_hint: "Only the rows above, same columns as the template.",
    ...
    seating_chart: {
      ...
      planner_size_round10: "Round · 10",
      planner_size_rect10: "Rectangular · 10",
      planner_size_banquet12: "Banquet · 12",
      planner_tables_label: "Tables needed",
  ...
  planners: {
    ...
    plan_unlimited_feature_1: "Everything in Pro",
  ...
  planner_profile: {
    ...
    styles_label: "Styles you work in",
    styles_hint: "Pick up to {max}. Couples filter and browse by these.",
  ...
  planner_points: {
    ...
    at_top: "You're at the top tier",
    how_to_earn: "How do you earn points?",
    earn_profile_completeness: "Complete your profile, for every 25%",
    earn_first_review: "Get your first review",
    earn_review_collected: "Collect a review from a couple",
    earn_client_linked: "A couple accepts you as their planner",
    earn_couple_invited: "A couple you invited joins Weddly",
    earned_so_far: "{n} so far",
    next_unlocks: "At {tier}:",
    perk_directory: "Higher in the planner directory",
    perk_badge: "Badge on your profile",
    rank_position_country: "#{rank} of {total} planners in {country}",
    rank_position_all: "#{rank} of {total} planners on Weddly",
    rank_gap: "{points} points to move up",
  },
  planner_setup: {
    title: "Finish your profile",
    body: "This is what a couple sees when they open you in the directory. Every step below is one more reason for them to write to you.",
    ring_label: "Profile completeness",
    progress: "{pct}% complete",
    cta: "Add",
    points_hint: "Every 25% earns you {points} Weddly points.",
    done_title: "Your profile is complete",
    done_body:
      "Everything a couple looks for is filled in. Keep your photos and packages fresh and the rest takes care of itself.",
    step_business_name: "Business name",
    step_city: "City you work from",
    step_bio: "A few words about your work",
    step_styles: "The styles you plan",
    step_has_photo: "At least one photo of your work",
    step_has_package: "At least one price package",
    step_has_availability: "The dates you are free",
  },
  planner_billing: {
  ...
  planner_directory: {
    ...
    verified_incomplete: "Verified planner · still finishing their profile",
    back: "Back",
    about_label: "About",
    styles_label: "Style",
    ...
    email_label: "Email",
    address_label: "Address",
    package_download: "Price list (PDF)",
    busy_label: "Availability",
    busy_next_free: "Next free date: {date}",
  },
  availability_calendar: {
    prev_month: "Previous month",
    next_month: "Next month",
    legend_booked: "Booked",
    legend_free_hint: "Tap a day to toggle it booked",
    empty: "No booked days marked",
    block_aria: "Mark {date} as booked",
    unblock_aria: "Mark {date} as free",
  },
  planner_offerings: {
    pricing_title: "Pricing & packages",
    pricing_subtitle:
      "Up to 3 packages, each with a price, description and optional price-list PDF.",
    add_package: "Add package",
    packages_full: "You've reached the 3-package limit.",
    new_package_default: "New package",
    package_name_label: "Package name",
    package_price_label: "Price (free text)",
    package_price_placeholder: "e.g. From €900",
    package_description_label: "Description",
    package_pdf_label: "Price-list PDF",
    package_pdf_upload: "Upload PDF",
    package_pdf_replace: "Replace PDF",
    package_pdf_remove: "Remove PDF",
    package_delete: "Delete package",
    package_delete_confirm: "Delete this package?",
    package_saved: "Package saved",
    package_deleted: "Package deleted",
    pdf_uploaded: "PDF uploaded",
    pdf_removed: "PDF removed",
    pdf_too_large: "PDF too large (max 8 MB).",
    pdf_invalid: "Only PDF files are allowed.",
    save_error: "Something went wrong.",
    availability_title: "Availability calendar",
    availability_subtitle: "Mark the days you're already booked. Couples see this on your profile.",
    availability_next_free: "Next free date: {date}",
    availability_none_free: "Every day in the next year is booked.",
    availability_error: "Couldn't update the calendar.",
    note_title: "Availability note",
    note_subtitle: "A short note about your free periods (shown next to the calendar).",
    note_placeholder: "e.g. Summer 2027 mostly open",
  ...
  guest_invites: {
    ...
    not_invited_alert: "{count} guests not invited yet",
    rsvp_title: "RSVP",
    rsvp_yes: "Coming",
    rsvp_no: "Declined",
    rsvp_maybe: "Maybe",
    rsvp_pending: "Pending",
    pending_alert: "{count} guests awaiting a reply",
    filter_label: "Filter",
    filter_all: "All",
    filter_awaiting: "Awaiting reply",
    filter_responded: "Responded",
    search_placeholder: "Search by name…",
    search_label: "Search guests",
    table_empty: "No guests yet. Add guests on the guest list first.",
    list_empty_filtered: "No guests match this filter.",
