...
const en: LocaleMessages = {
  ...
  budget: {
    ...
    top_movers_sub: "Your three heaviest lines. One tap drops the ones you don't actually need.",
    top_movers_skip: "Don't need this",
    top_movers_skip_aria: "Drop “{label}” from the budget",
    top_movers_skipped: "“{label}” dropped",
    top_movers_undo: "Undo",
