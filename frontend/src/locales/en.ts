...
const en: LocaleMessages = {
  ...
  outreach: {
    ...
    label_body: "Message",
    label_supplier_ids: "Supplier IDs",
    label_supplier_ids_placeholder: "etyeki-kuria, c12, …",
    label_supplier_ids_help:
      "Comma- or space-separated, up to {max}. Find the ID in the directory card's URL.",
    err_no_suppliers: "Add at least one supplier ID.",
