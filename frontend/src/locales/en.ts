...
const en: LocaleMessages = {
  ...
  vendor: {
    ...
    clients: {
      ...
      stage_placeholder: "e.g. proposal sent",
    ...
    billing: {
      ...
      status_label: "Status",
      founding_until: "Founding member, free until {date}.",
      trial_until: "Trial active through {date}.",
      entitled_yes: "Your listing is live.",
      entitled_no: "Your listing is hidden until you subscribe. Your data is safe.",
      ...
      upgrade_value: "Unlock the full client CRM, payment tracking, and advanced stats.",
    ...
    settings: {
      ...
      data_export_body: "Download a copy of your account and listing data.",
    ...
    upgrade: {
      ...
      body: "Unlock the full client CRM, payment tracking, advanced stats, and the response workflow.",
      cta: "Upgrade to Pro",
  ...
  vendor_demo: {
    banner_title: "Gingy's Wedding Cakes demo · changes vanish",
  ...
  planner_home: {
    ...
    rail_actions_title: "Quick actions",
    rail_action_add_client: "New client",
    rail_action_profile: "Edit profile",
    rail_action_messages: "Messages",
