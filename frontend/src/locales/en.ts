...
const en: LocaleMessages = {
  ...
  planners: {
    ...
    hero_body:
      "Coordinating six weddings at once is its own art form. Weddly's planner workspace is built for exactly that — guest list, seating, tasks, and documents across all your couples, finally in one place.",
    ...
    plan_pro_feature_3: "Early-adopter pricing",
    ...
    features_tagline: "Not a generic project tool repurposed for weddings — something built for the real work from day one.",
    feature_guestlist_name: "Guest list",
    feature_guestlist_desc: "RSVPs, dietary notes, invite status — every couple's guest picture clear and up to date.",
    feature_seating_name: "Seating chart",
    feature_seating_desc: "Drag-and-drop table layouts with PDF export, so the last-minute seating scramble stays in the past.",
