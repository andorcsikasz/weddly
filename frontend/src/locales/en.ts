...
const en: LocaleMessages = {
  ...
  honeymoon: {
    title: "Honeymoon",
    sub: "Plan the trip — destination, dates, packing, budget — without leaving the workspace.",
    coming_soon_title: "Coming soon",
    coming_soon_body:
      "Destination notes, dates, packing checklist, and a budget tie-in with the existing Honeymoon line will live here. Until then, jot ideas in the Budget page note for the Honeymoon category.",
    budget_title: "Honeymoon budget",
    budget_planned_label: "Allocated",
    budget_actual_label: "Spent so far",
    budget_remaining_label: "Remaining",
    budget_empty_hint:
      "No Honeymoon line in the budget yet. Open Budget and add one to surface the allocation here.",
    budget_open_link: "Open Budget",
    budget_lines_count_one: "1 line in the budget",
    budget_lines_count_other: "{count} lines in the budget",
  },
  media: {
    title: "Photos",
