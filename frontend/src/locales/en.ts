...
const en: LocaleMessages = {
  ...
  planners: {
    ...
    hero_title: "Manage all your couples\nin one place.",
    hero_body:
      "The planner workspace brings every tool together — guest list, seating, tasks, documents — across all your couples, on one surface.",
    hero_cta: "Choose a plan",
    ...
    pricing_active_note: "Active couple = a wedding actively managed within the current calendar year.",
    ...
    placeholder_message: "Tell us what you'd expect from a planner tool, what's missing for you now…",
    privacy_consent_prefix: "I have read and accept the",
