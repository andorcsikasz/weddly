...
export interface LocaleMessages {
  ...
  vendors: {
    ...
    demo_loading: string;
    demo_error: string;
    pitch_manage_eyebrow: string;
    pitch_manage_title: string;
    pitch_manage_b1: string;
    pitch_manage_b2: string;
    pitch_manage_b3: string;
    pitch_grow_eyebrow: string;
    pitch_grow_title: string;
    pitch_grow_b1: string;
    pitch_grow_b2: string;
    pitch_grow_b3: string;
    pitch_book_eyebrow: string;
    pitch_book_title: string;
    pitch_book_b1: string;
    pitch_book_b2: string;
    pitch_book_b3: string;
    pitch_mock_booked: string;
    pitch_mock_held: string;
    pitch_mock_new_inquiry: string;
    pitch_mock_reply: string;
    pitch_mock_quote: string;
    pitch_mock_accepted: string;
    pitch_mock_line_1: string;
    pitch_mock_line_2: string;
    pitch_mock_line_3: string;
    pitch_mock_total: string;
    pitch_mock_deposit: string;
    pitch_mock_balance: string;
    pitch_mock_paid: string;
    pitch_mock_due: string;
    pitch_trades_title: string;
    pitch_trades_cta: string;
    pitch_faq_title: string;
    pitch_faq_1_q: string;
    pitch_faq_1_a: string;
    pitch_faq_2_q: string;
    pitch_faq_2_a: string;
    pitch_faq_3_q: string;
    pitch_faq_3_a: string;
    pitch_faq_4_q: string;
    pitch_faq_4_a: string;
    pitch_faq_5_q: string;
    pitch_faq_5_a: string;
    pitch_faq_6_q: string;
    pitch_faq_6_a: string;
  };
  vendor_register: {
  ...
  admin: {
    ...
    fin_title: string;
    fin_subtitle: string;
    fin_launch_title: string;
    fin_launch_note: string;
    fin_launch_live_count: string;
    fin_launch_paywall_separate: string;
    fin_launch_loading: string;
    fin_launch_retry: string;
    fin_launch_refresh: string;
    fin_launch_load_error_title: string;
    fin_launch_load_error_body: string;
    fin_launch_state_live: string;
    fin_launch_state_blocked: string;
    fin_launch_state_off: string;
    fin_launch_ready: string;
    fin_launch_not_ready: string;
    fin_launch_missing: string;
    fin_launch_last_changed: string;
    fin_launch_revision: string;
    fin_launch_enable: string;
    fin_launch_disable: string;
    fin_launch_fix_config: string;
    fin_launch_updating: string;
    fin_launch_confirm_on_title: string;
    fin_launch_confirm_on_body: string;
    fin_launch_confirm_off_title: string;
    fin_launch_confirm_off_body: string;
    fin_launch_disable_paywall_body: string;
    fin_launch_on_success: string;
    fin_launch_off_success: string;
    fin_launch_update_error: string;
    fin_launch_overview_refresh_error: string;
    fin_launch_conflict: string;
    fin_launch_smoke_title: string;
    fin_launch_smoke_warning: string;
    fin_launch_smoke_account: string;
    fin_launch_smoke_checkout: string;
    fin_launch_smoke_webhook: string;
    fin_launch_smoke_manage: string;
    fin_launch_smoke_pause: string;
    fin_launch_product_couple_subscriptions: string;
    fin_launch_product_couple_subscriptions_note: string;
    fin_launch_product_planner_subscriptions: string;
    fin_launch_product_planner_subscriptions_note: string;
    fin_launch_product_vendor_billing: string;
    fin_launch_product_vendor_billing_note: string;
    fin_launch_product_film_checkout: string;
    fin_launch_product_film_checkout_note: string;
    fin_launch_product_guest_page_addon: string;
    fin_launch_product_guest_page_addon_note: string;
    ...
    fin_enforce_launch_prereq: string;
  ...
  tools: {
    ...
    guest_list_template: {
      ...
      try_h2: string;
      try_caption: string;
      try_first_name_placeholder: string;
      try_last_name_placeholder: string;
      try_household_placeholder: string;
      try_diet_placeholder: string;
      try_plus_one_placeholder: string;
      try_status_pending: string;
      try_status_yes: string;
      try_status_no: string;
      try_add_btn: string;
      try_remove_label: string;
      try_empty: string;
      try_count_label: string;
      try_download_btn: string;
      try_download_hint: string;
      download_h2: string;
      download_body: string;
    ...
    seating_chart: {
      ...
      planner_size_round10: string;
      planner_size_rect10: string;
      planner_size_banquet12: string;
      planner_tables_label: string;
