...
const hu: LocaleMessages = {
  ...
  schedule: {
    ...
    empty_body: "Adj hozzá programpontokat, vagy indulj egy alap menetrenddel.",
    starter_button: "Alap menetrend létrehozása",
    starter_arrival: "Megérkezés",
    starter_ceremony: "Polgári szertartás",
    starter_group_photo: "Csoportkép",
    starter_dinner: "Vacsora",
    starter_first_dance: "Első tánc",
