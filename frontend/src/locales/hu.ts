...
const hu: LocaleMessages = {
  ...
  vendor_activate: {
    ...
    founding_note: "Az első 100 szolgáltató egy teljes évig a vendégünk.",
    early_badge: "Korai hozzáférés · {left}/{cap} hely szabad",
    early_note: "300 szolgáltató három hónapig a vendégünk, és még van szabad hely.",
    cohort_full_note:
  ...
  admin: {
    ...
    vendors: {
      ...
      founding_tooltip: "Alapító tag — az első 100 szolgáltató egyike.",
