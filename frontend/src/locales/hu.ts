...
const hu: LocaleMessages = {
  ...
  admin: {
    ...
    waitlist_empty: "Még nincs jelentkezés.",
    waitlist_col_business: "Vállalkozás",
    waitlist_col_category: "Kategória",
    waitlist_col_submitted: "Beérkezett",
    waitlist_col_status: "Állapot",
    waitlist_col_actions: "Műveletek",
    waitlist_status_new: "Új",
    waitlist_status_contacted: "Megkerestük",
    waitlist_status_dismissed: "Elutasítva",
    waitlist_mark_contacted: "Megkerestem",
    waitlist_dismiss: "Elutasít",
    waitlist_reopen: "Újra megnyit",
