...
const hu: LocaleMessages = {
  ...
  planners: {
    ...
    hero_title: "Kezeld az összes párodat\negy helyen.",
    hero_body:
      "A szervező munkaterület megnyitja az összes eszközt — vendéglista, ültetés, feladatok, dokumentumok — minden párodnál, egy felületen.",
    hero_cta: "Válassz csomagot",
