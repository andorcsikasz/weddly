...
const hu: LocaleMessages = {
  ...
  outreach: {
    ...
    label_subject: "Tárgy",
    label_body: "Üzenet",
    label_supplier_ids: "Szolgáltató ID-k",
    label_supplier_ids_placeholder: "etyeki-kuria, c12, …",
    label_supplier_ids_help:
      "Vesszővel vagy szóközzel elválasztva, legfeljebb {max} db. Az ID a katalógus kártya URL-jében szerepel.",
    err_no_suppliers: "Adj meg legalább egy szolgáltató ID-t.",
