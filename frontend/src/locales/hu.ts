...
const hu: LocaleMessages = {
  ...
  planners: {
    ...
    submit: "Feliratkozom a várólistára",
    submitting: "Küldés…",
    success_title: "Köszönjük a jelentkezést!",
    success_body:
      "Felvettük az adataidat. Amint a szervezői felület közeleg, elsőként szólunk neked személyesen.",
    back_home: "Vissza a főoldalra",
    ...
    benefit_3_title: "Korai hozzáférés",
    benefit_3_body:
      "A várólistán lévő szervezők alakítják a terméket. Az első fázisban ingyenes a hozzáférés.",
