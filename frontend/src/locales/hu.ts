...
const hu: LocaleMessages = {
  ...
  vendor: {
    ...
    billing: {
      ...
      entitled_no:
        "Alap csomagon vagy. A listinged látható marad, de a közvetlen megkeresések és a naptár nem aktív.",
    ...
    settings: {
      ...
      data_export_body:
        "Tölts le egy másolatot a fiókod, a listinged, az ügyfeleid és a számlázási adataid teljes tartalmáról egyetlen JSON fájlban.",
      ...
      data_delete_desc:
        "A szolgáltatói fiók törlése a listingedet is eltávolítja. Jelenleg e-mailben intézzük: írj nekünk, és 30 napon belül véglegesen töröljük az adataidat.",
  ...
  vendor_calendar: {
    ...
    availability_no_listing:
      "A foglaltsági naptár a listinged aktiválása után nyílik meg. A teendőtáblát már most használhatod.",
