...
const hu: LocaleMessages = {
  ...
  photos: {
    loading: "Betoltes…",
    not_found: "Ez a link lejart vagy nem letezik.",
    not_found_sub: "Kerj a pártol egy friss QR-kodot.",
    uploads_disabled: "A feltoltes le van zarva.",
    uploads_disabled_sub: "A par most nem fogad kepeket.",
    name_heading: "Mi a neved?",
    name_sub: "Hogy a par tudja, kitol erkezett a kep.",
    name_placeholder: "A neved",
    name_skip: "Kihagyas",
    name_continue: "Tovabb",
    ready_heading: "Kuldes egy kepet",
    ready_sub: "Koppints a gombra, es valassz kepet a kameradbol vagy galeriabool.",
    ready_sub_limit: "Legfeljebb {{n}} kepet kuldhetsz.",
    choose_photo: "Kep kivalasztasa",
    uploading: "Feltoltes…",
    success_heading: "Kep elkuldve!",
    success_sub: "A par latni fogja.",
    success_add_more: "Meg egyet kuld",
    limit_heading: "Keszen vagy!",
    limit_sub: "Elkuldted a {{n}} kepedet. Koszonjuk.",
    error_too_large: "A fajl tul nagy. Kerlek valassz 8 MB alatti kepet.",
    error_bad_type: "Csak JPEG, PNG es WebP kepeket fogadunk.",
    error_generic: "Valami hiba tortent. Kerlek probald ujra.",
    shot_count: "{{used}} / {{max}} kep felhasznalva",
  },
  design: {
    title: "Arculat",
