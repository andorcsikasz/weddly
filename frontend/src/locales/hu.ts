...
const hu: LocaleMessages = {
  ...
  planners: {
    ...
    hero_body:
      "Tudjuk, milyen az, amikor egyszerre hat esküvő fut párhuzamosan. A Weddly szervező munkaterülete pontosan erre épül — vendéglista, ültetés, feladatok és dokumentumok, minden párodnál, egy helyen.",
    ...
    features_tagline: "Nem egy általános projektmenedzsment eszköz — hanem valami, amit esküvőkre terveztek.",
    feature_guestlist_name: "Vendéglista",
    feature_guestlist_desc: "RSVP-kezelés, étkezési igények, meghívó státuszok — minden párodnál átláthatóan rendben.",
    feature_seating_name: "Ültetési terv",
    feature_seating_desc: "Húzd-ejtsd asztalelrendezés, PDF export nyomtatáshoz — soha többé utolsó pillanatos ültetési pánik.",
