...
const hu: LocaleMessages = {
  ...
  dashboard: {
    ...
    greeting: {
      ...
      morning: "Jó reggelt, {name}!",
      midday: "Készen álltok a mai napra, {name}?",
      afternoon: "Jó napot, {name}!",
      early_evening: "Jó látni titeket, {name}!",
      evening: "Jó estét, {name}!",
      night: "Még ébren vagytok, {name}?",
      christmas: "Boldog karácsonyt, {name}!",
      new_year: "Boldog új évet, {name}!",
      valentines: "Boldog Valentin-napot, {name}!",
      easter: "Kellemes húsvétot, {name}!",
    ...
    kpi_days_elapsed_progress: "{elapsed} nap eltelt · {left} hátra",
  ...
  quiz: {
    list: {
      title: "Kvíz",
      subtitle:
        "Építsetek egy élő kvízt magatokról, és játsszátok végig együtt a vendégekkel a lakodalomban.",
      new_button: "Új kvíz",
      create_prompt_label: "Kvíz neve",
      create_placeholder: "pl. Mennyire ismertek minket?",
      create_submit: "Létrehozás",
      create_cancel: "Mégse",
      empty_title: "Még nincs egy kvíz sem",
      empty_body: "Hozzatok létre egyet, és kezdjetek kérdéseket felvenni.",
      status_draft: "Piszkozat",
      status_live: "Élő",
      status_ended: "Lezárva",
      slides_count: "Diák: {count}",
      edit_button: "Szerkesztés",
      host_button: "Levezetés",
      delete_confirm_title: "Törlöd ezt a kvízt?",
      delete_confirm_body: 'A(z) "{title}" kvíz és minden pontszáma véglegesen elvész.',
    },
    builder: {
      prompt_label: "Kérdés",
      section_title_label: "Kör címe",
      subtitle_label: "Alcím",
      kind_mcq: "4 válasz",
      kind_binary: "A vagy B",
      kind_number: "Szám",
      kind_heatmap: "Hőtérkép",
      kind_section: "Kör",
      kind_story: "Történet",
      options_label: "Válaszok",
      option_placeholder: "{n}. válasz",
      mark_correct: "Ez a helyes válasz",
      no_correct_answer: "Nincs helyes válasz",
      min_label: "Minimum",
      max_label: "Maximum",
      step_label: "Lépésköz",
      unit_label: "Mértékegység",
      correct_value_label: "Helyes érték",
      x_low_placeholder: "Alsó vég (bal)",
      x_high_placeholder: "Felső vég (jobb)",
      y_low_placeholder: "Alsó vég (lent)",
      y_high_placeholder: "Felső vég (fent)",
      axis_default_low: "Alacsony",
      axis_default_high: "Magas",
      heatmap_target_hint: "Koppints a mezőre a helyes pont beállításához",
      time_limit_label: "Időkorlát (másodperc)",
      untimed_placeholder: "Nincs korlát",
      points_label: "Pontok",
      move_up: "Feljebb",
      move_down: "Lejjebb",
      save: "Mentés",
      saved: "Mentve",
      empty_state: "Adjatok hozzá egy diát a kezdéshez.",
      go_live: "Indítás élőben",
      go_live_confirm_title: "Elindítod a kvízt?",
      go_live_confirm_body:
        "A diák zárolva lesznek, amíg élőben megy. A szerkesztéshez zárd le vagy állítsd vissza a menetet.",
      go_live_confirm_action: "Indítás",
      open_host: "Levezetőpult megnyitása",
      locked_banner:
        "Ez a kvíz most élőben megy — a diák szerkesztéséhez zárd le vagy állítsd vissza a menetet.",
      delete_slide_confirm_title: "Törlöd ezt a diát?",
    },
    host: {
      draft_body: "Bármikor indíthatod — az indítás megnyitja a szobát a vendégeknek.",
      start_button: "Indítás",
      join_code_label: "Csatlakozási kód",
      qr_alt: "QR-kód a kvízhez való csatlakozáshoz",
      lobby_hint: "A vendégek a kóddal vagy a linkkel csatlakoznak.",
      no_players_yet: "Várakozás az első vendégre…",
      begin_button: "Kör indítása",
      answered_count: "{answered} / {total} válaszolt",
      reveal_button: "Megoldás",
      next_button: "Következő",
      end_button: "Kvíz lezárása",
      final_leaderboard_title: "Végeredmény",
      reset_button: "Visszaállítás új menethez",
      reset_confirm_title: "Visszaállítod a kvízt?",
      reset_confirm_body:
        "Minden játékos és pontszám törlődik, és új csatlakozási kód készül. A diák megmaradnak.",
      reset_confirm_action: "Visszaállítás",
      round_progress: "{current}. / {total} kör",
    },
    play: {
      join_kicker: "Meghívást kaptál a játékra",
      hosted_by: "Levezeti: {name}",
      name_label: "A neved",
      name_placeholder: "Hogy szólítsunk?",
      avatar_label: "Válassz karaktert",
      join_button: "Csatlakozás",
      waiting_title: "Bent vagy, {name}!",
      waiting_body: "Várakozás, amíg a levezető elindítja…",
      players_joined: "{count} csatlakozott eddig",
      answer_locked_in: "Válasz rögzítve — várunk a többiekre…",
      correct_banner: "Helyes! +{points}",
      incorrect_banner: "Nem egészen",
      correct_value: "A helyes válasz: {value}",
      no_correct_answer: "Ehhez nincs helyes válasz",
      your_rank_score: "Te vagy a(z) {rank}. helyen, {score} ponttal",
      submit_answer: "Beküldés",
      ended_title: "Ennyi volt a kvíz!",
      your_rank: "A(z) {rank}. helyen végeztél",
      not_found_title: "A kvíz nem található",
      not_found_body:
        "Ehhez a kódhoz nem tartozik kvíz. Ellenőrizd a linket, vagy kérj újat a levezetőtől.",
    },
  },
  markets: {
    page_title: "Jóslatok",
    ...
    status_live: "Élő — a vendégek csatlakozhatnak és fogadhatnak",
    status_ended: "Szüneteltetve — nincs új csatlakozás vagy fogadás",
    start_button: "Élesítés",
    end_button: "Szüneteltetés",
    resume_button: "Folytatás",
    join_code_label: "Csatlakozási kód",
    share_link_label: "Vendég link",
    copy_link: "Link másolása",
    copied: "Másolva!",
    qr_alt: "QR-kód a jóslatokhoz való csatlakozáshoz",
    add_question_title: "Kérdés hozzáadása",
    prompt_label: "Kérdés",
    prompt_placeholder: "Elsírja magát a vőlegény az eskü alatt?",
    closes_label: "Fogadás zárása",
    add_button: "Kérdés hozzáadása",
    empty_title: "Még nincs kérdés",
    empty_body: "Add hozzá az elsőt alul.",
    question_status_open: "Nyitott",
    question_status_closed: "Lezárva — eredményre vár",
    question_status_resolved: "Lezárt",
    question_status_voided: "Érvénytelenítve — visszatérítve",
    pool_label: "{yes} pont IGEN · {no} pont NEM",
    probability_label: "{pct}% esély",
    resolve_yes: "Az igen nyert",
    resolve_no: "A nem nyert",
    void_button: "Érvénytelenítés",
    void_confirm_title: "Érvényteleníted ezt a kérdést?",
    void_confirm_body: "Minden tétet teljes egészében visszatérítünk. Ez nem vonható vissza.",
    delete_button: "Törlés",
    delete_confirm_title: "Törlöd ezt a kérdést?",
    delete_confirm_body: "Még senki sem fogadott rá, szóval nincs mit visszatéríteni.",
    leaderboard_title: "Ranglista",
    leaderboard_empty: "Még senki sem csatlakozott.",
    balance_pts: "{balance} pont",
    outcome_label: "Eredmény: {outcome}",
    save_error: "Nem sikerült menteni. Próbáld újra.",
    stat_open_questions: "Nyitott kérdés",
    stat_total_staked: "Feltett pont",
    stat_guests: "Vendég",
  ...
  markets_play: {
    ...
    name_label: "A neved",
    name_placeholder: "Hogy szólítsunk?",
    avatar_label: "Válassz egy karaktert",
    join_button: "Csatlakozás",
    balance_label: "A pontjaid",
    bet_yes: "Igen",
    bet_no: "Nem",
    stake_label: "Fogadott pontok",
    estimated_return_label: "Becsült nyeremény",
    estimated_return_hint:
      "Ha addig más nem fogad. A végleges nyeremény csak a kérdés lezárásakor dől el.",
    profit_label: "Nyereség, ha nyersz",
    place_bet: "Fogadás megtétele",
    your_position: "{stake} pontot tettél a(z) {side} oldalra",
    position_value: "Jelenlegi érték: kb. {value} pont",
    closes_in: "Zárás: {when}",
    closed_note: "A fogadás lezárult — eredményre vár",
    resolved_note: "Eredmény: {outcome}",
    voided_note: "Érvénytelenítve — a téted visszatérítettük",
    you_won: "{payout} pontot nyertél",
    you_lost: "Ezt most nem sikerült",
    leaderboard_title: "Ranglista",
    not_live_note: "Ez a tábla még nem nyitott — nézz vissza hamarosan.",
    ended_note: "A pár szüneteltette ezt a táblát.",
    not_found_title: "A tábla nem található",
    not_found_body: "Ehhez a kódhoz nem tartozik jóslattábla. Ellenőrizd a linket.",
    insufficient_balance: "Nincs elég pontod",
    side_locked: "Erre a kérdésre már a másik oldalra fogadtál",
  },
  schedule: {
    title: "Programterv",
  ...
  budget: {
    ...
    subcategory_quick_add: "Gyors hozzáadás:",
    subcat: {
      photo_video: { photo: "Fotó", video: "Videó" },
      music_dj: { dj: "DJ", live_music: "Élőzene" },
      decor_floral: { decor: "Dekor", flowers: "Virág" },
      attire: { bride: "Menyasszony", groom: "Vőlegény" },
      hair_makeup: { hair: "Haj", makeup: "Smink" },
    },
  },
  diy: {
  ...
  admin: {
    ...
    table_workspace_total_time: "Összes idő",
    total_time_tooltip: "Az appban töltött idő összesen",
    total_time_none: "-",
    total_time_under_minute: "<1 perc",
    total_time_minutes: "{n} perc",
    total_time_hm: "{h} óra {m} perc",
    total_time_dh: "{d} nap {h} óra",
    ...
    status_pending: "Admin jóváhagyásra vár",
    status_awaiting_review: "Tulajdonos igazolva",
    filter_status_label: "Szűrés",
    filter_status_all: "Összes",
    filter_status_pending: "Jóváhagyásra vár",
    filter_status_awaiting_review: "Tulajdonos igazolva",
    ...
    approve_hint: "Élesíti az adatlapot, és e-mailben értesíti a szolgáltatót, hogy felkerült.",
    send_verify: "Visszaigazolás küldése",
    send_verify_hint:
      "Nem kötelező — a jóváhagyás előtt megkérheted a szolgáltatót, hogy igazolja a tulajdonjogot.",
    ...
    analytics_money_avg_planned_per_head: "Átlagos tervezett / fő",
    analytics_money_avg_actual_per_head: "Átlagos tényleges / fő",
    analytics_money_per_head_denom: "A cél létszámot megadó párokra",
    ...
    analytics_money_col_avg_planned_per_head: "Átl. tervezett / fő",
    analytics_money_col_avg_actual_per_head: "Átl. tényleges / fő",
  ...
  tools: {
    ...
    guest_list_template: {
      ...
      try_h2: "Próbáld ki, adj hozzá egy-két vendéget",
      try_caption:
        "Írj be pár valódi nevet alább, és nézd, ahogy a lista megtelik. Töltsd le pontosan azt, amit beírtál, regisztráció nélkül.",
      try_first_name_placeholder: "Keresztnév",
      try_last_name_placeholder: "Vezetéknév",
      try_household_placeholder: "Háztartás",
      try_diet_placeholder: "Étrend (opcionális)",
      try_plus_one_placeholder: "Kísérő (opcionális)",
      try_status_pending: "Függőben",
      try_status_yes: "Jön",
      try_status_no: "Nem jön",
      try_add_btn: "Vendég hozzáadása",
      try_remove_label: "Törlés",
      try_empty: "Még nincs vendég, add hozzá az elsőt alább.",
      try_count_label: "Vendég a listádban",
      try_download_btn: "Lista letöltése CSV-ként",
      try_download_hint: "Csak a fenti sorok, ugyanazokkal az oszlopokkal, mint a sablon.",
    ...
    seating_chart: {
      ...
      planner_size_round10: "Kerek · 10 fő",
      planner_size_rect10: "Szögletes · 10 fő",
      planner_size_banquet12: "Hosszú asztal · 12 fő",
      planner_tables_label: "Ennyi asztal kell",
