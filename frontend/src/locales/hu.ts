...
const hu: LocaleMessages = {
  ...
  planning: {
    ...
    checklist: {
      ...
      create_body:
        "Hozzatok létre egy teljes időrendi listát, amely a Tervezés feladataihoz kapcsolódik.",
      create_action: "Ellenőrzőlista létrehozása",
      ...
      initializing: "Ellenőrzőlista készítése…",
