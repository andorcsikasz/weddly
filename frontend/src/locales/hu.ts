...
const hu: LocaleMessages = {
  ...
  vendorBrowse: {
    ...
    convert_sub:
      "Ez csak ízelítő. Hozz létre egy fiókot, böngészd az összes szolgáltatót, mentsd a kedvenceket, és keresd őket közvetlenül telefonon, e-mailben vagy Instagramon.",
