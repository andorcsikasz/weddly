...
const hu: LocaleMessages = {
  ...
  honeymoon: {
    title: "Nászút",
    sub: "Tervezzétek meg a nászutatokat — úti cél, dátumok, csomagolás, költségvetés — egy helyen.",
    coming_soon_title: "Hamarosan",
    coming_soon_body:
      "Úticél jegyzetek, dátumok, csomagolási checklist és a Nászút költségsorral összekötött összeg itt fog megjelenni. Addig is jegyezz fel ötleteket a Költségvetés oldalon a Nászút kategóriánál.",
    budget_title: "Nászút keret",
    budget_planned_label: "Tervezett",
    budget_actual_label: "Eddigi költés",
    budget_remaining_label: "Még elkölthető",
    budget_empty_hint:
      "Még nincs Nászút sor a költségvetésben. Nyisd meg a Költségvetést és add hozzá, hogy itt is megjelenjen a keret.",
    budget_open_link: "Költségvetés megnyitása",
    budget_lines_count_one: "1 tétel a költségvetésben",
    budget_lines_count_other: "{count} tétel a költségvetésben",
  },
  media: {
    title: "Képek",
