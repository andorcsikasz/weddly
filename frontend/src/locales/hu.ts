...
const hu: LocaleMessages = {
  ...
  wedding_site_editor: {
    ...
    cover_image_label: "Borítókép URL",
    cover_image_placeholder: "https://…",
    cover_image_hint:
      "Másold be egy nyilvánosan elérhető kép http(s) linkjét. Most még nincs feltöltés — ez egy átmeneti megoldás.",
  ...
  admin: {
    ...
    action_verify_label: "Hitelesítő",
    action_flag_label: "Megjelölés",
    action_unflag_label: "Feloldás",
    action_delete_label: "Törlés",
