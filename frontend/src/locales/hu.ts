...
const hu: LocaleMessages = {
  ...
  subscription_terms: {
    ...
    contact_body:
      "Az ÁSZF-fel és a Wēddly szolgáltatóknak nyújtott szolgáltatásával kapcsolatos minden megkeresést a hello@weddly.xyz címre várunk; panasz, mediáció vagy DSA-bejelentés céljából a panasz@weddly.xyz cím is használható. Az Üzemeltető Ektv. 4. § szerinti azonosító adatait az Impresszum oldal tartalmazza.",
    en_section_label: "English",
  },
  imprint: {
