...
const hu: LocaleMessages = {
  ...
  planners: {
    ...
    step0_title: "Válassz csomagot",
    step1_title: "Mutatkozz be",
    step2_title: "Vállalkozásodról",
    step3_title: "Már majdnem kész",
    step_label_plan: "Csomag",
    step_label_intro: "Bemutatkozás",
    step_label_business: "Vállalkozás",
    step_label_usage: "Felhasználás",
    ...
    label_city: "Város / régió, ahol dolgozol",
    placeholder_city: "pl. Budapest",
    label_years: "Hány éve dolgozol esküvőszervező területen?",
    label_website: "Weboldal",
    placeholder_website: "pl. kovacspetraszkuveszo.hu",
    label_weddings_per_year: "Hány esküvőt szervezel évente körülbelül?",
    placeholder_weddings_per_year: "pl. 12",
    label_usage: "Mire használnád leginkább?",
    usage_guestlist: "Vendéglista kezelés",
    usage_seating: "Ültetésterv",
    usage_tasks: "Feladatkezelés",
    usage_all: "Mindhárom egyformán",
