...
const hu: LocaleMessages = {
  ...
  planner_activate: {
    ...
    page_body:
      "A profilod elkészült a Weddly-n, 2 év ingyenes hozzáféréssel. Élesítsd egy perc alatt.",
  ...
  planner_onboarding: {
    ...
    plan_coming_soon:
      "Az első 25 tervező 2 évig ingyen használhatja, utána 3 napos próbaidőszak jár a választott csomagra.",
  ...
  planner_billing: {
    ...
    founding_spots: "Még {n} ingyenes alapító hely a 25-ből",
    state_founding: "Alapító tag · ingyenes {date}-ig",
