...
const hu: LocaleMessages = {
  ...
  vendorBrowse: {
    ...
    convert_title: "Az egész esküvő elfér itt",
    convert_sub:
      "A böngészéshez nem kell fiók. Regisztrálj, hogy elmentsd, akik tetszenek, írhass nekik, és egy helyen legyen a költségvetés, a vendéglista és az ültetés is.",
