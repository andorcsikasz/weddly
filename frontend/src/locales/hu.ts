...
const hu: LocaleMessages = {
  ...
  vendor_calendar: {
    ...
    block_editor_title: "{date} foglaltsága",
    block_mode_label: "Foglaltság típusa",
    ...
    blocked_all_day_label: "Egész nap foglalt",
    blocked_hours_label: "Foglalt {from}-{to} ({count} ó)",
    section_availability: "Foglaltság",
    availability_intro:
