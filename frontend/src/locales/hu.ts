...
const hu: LocaleMessages = {
  ...
  admin: {
    ...
    analytics_nav_acquisition: "Szerzés",
    ...
    analytics_section_acquisition: "Szerzés",
    analytics_acq_window: "utolsó {n} nap",
    analytics_acq_load_error: "Nem sikerült betölteni a szerzési adatokat.",
    analytics_acq_empty: "Még nincs szerzési adat ebben az ablakban.",
    analytics_acq_unknown: "ismeretlen",
    analytics_acq_total_signups: "Regisztrációk",
    analytics_acq_onboarded_rate: "Onboardolt",
    analytics_acq_active_rate: "Aktív",
    analytics_acq_top_channel: "Vezető csatorna",
    analytics_acq_unknown_country: "Ismeretlen ország",
    analytics_acq_conversion_sub: "regisztráció → onboard → aktív",
    analytics_acq_by_country_title: "Konverzió ország szerint",
    analytics_acq_by_channel_title: "Csatorna",
    analytics_acq_by_device_title: "Eszköz",
    analytics_acq_campaigns_title: "Kampányok",
    analytics_acq_campaigns_sub: "aktiváció szerint",
    ...
    analytics_acq_channel_direct: "Közvetlen",
