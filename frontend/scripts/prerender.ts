...
function buildBody(L: LocaleMessages, locale: SeoFaqLocale): string {
  ...
  return [
    ...
    `  <article><h3>${escape(l.why_a_title)}</h3><p>${escape(l.why_a_body)}</p></article>`,
    `  <article><h3>${escape(l.why_b_title)}</h3><p>${escape(l.why_b_body)}</p></article>`,
    `  <article><h3>${escape(l.why_c_title)}</h3><p>${escape(l.why_c_body)}</p></article>`,
    `  <article><h3>${escape(l.why_d_title)}</h3><p>${escape(l.why_d_body)}</p></article>`,
    `</section>`,
